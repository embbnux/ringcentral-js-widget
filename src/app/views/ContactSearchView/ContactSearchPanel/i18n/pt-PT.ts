...
export default {
  [HintsType.thirdPartyNoRecordsContent]:
    'Introduza, pelo menos, {minimumLength} carateres para pesquisar contactos {sourceName}.',
  ...
  doNotCall: 'Não ligar',
  enterNameOrNumber: 'Nome ou número...',
  enterANameOrNumber: 'Introduzir um nome ou número',
  to: 'Para',
  dial: 'Marcar',
  message: 'Mensagem',
  transfer: 'Transferir',
