...
var _default = exports["default"] = (_HintsType$thirdParty = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, _ContactSearchPanelEnum.HintsType.thirdPartyNoRecordsContent, 'Introduzca como mínimo {minimumLength} caracteres para buscar {sourceName} contactos.'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsTitle, 'No se encontraron resultados'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsContent, 'Compruebe los resultados de otros orígenes o cambie su contraseña.'), _ContactSearchPanelEnum.HintsType.searching, 'Buscando…'), "companyTabTitle", 'Empresa'), "personalTabTitle", 'Personal'), "direct", 'Directo'), "contact", 'Contacto'), "mobile", 'Móvil'), "company", 'Empresa'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "home", 'Casa'), "home2", 'Casa'), "other", 'Otro'), "business", 'Trabajo'), "business2", 'Empresa'), "car", 'Coche'), "fax", 'Fax'), "assistant", 'Asistente'), "callback", 'Devolución de llamada'), "MobileNumber", 'Número de móvil'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "ContactNumber", 'Número de contacto'), "DirectNumber", 'Número directo'), "doNotCall", 'No llamar'), "enterNameOrNumber", 'Nombre o teléfono...'), "enterANameOrNumber", 'Introducir el nombre o el número'), "to", 'A'), "dial", 'Marcación'), "message", 'Mensaje'), "transfer", 'Transferir'), "delete", 'Eliminar'), _defineProperty(_HintsType$thirdParty, "invalidPhoneNumber", 'Número de teléfono no válido.')); // @key: @#@"[HintsType.thirdPartyNoRecordsContent]"@#@ @source: @#@"Enter at least {minimumLength} characters to search {sourceName} contacts."@#@
