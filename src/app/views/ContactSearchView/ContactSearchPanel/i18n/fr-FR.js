...
var _default = exports["default"] = (_HintsType$thirdParty = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, _ContactSearchPanelEnum.HintsType.thirdPartyNoRecordsContent, 'Entrez au moins {minimumLength} caractères pour rechercher des contacts {sourceName}.'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsTitle, 'Aucun résultat'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsContent, 'Vérifiez les résultats d’autres sources ou modifiez votre mot clé.'), _ContactSearchPanelEnum.HintsType.searching, 'Recherche…'), "companyTabTitle", 'Entreprise'), "personalTabTitle", 'Personnel'), "direct", 'Direct'), "contact", 'Contact'), "mobile", 'Mobile'), "company", 'Entreprise'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "home", 'Domicile'), "home2", 'Domicile'), "other", 'Autre'), "business", 'Professionnel'), "business2", 'Professionnel'), "car", 'Véhicule'), "fax", 'Fax'), "assistant", 'Assistant'), "callback", 'Rappel'), "MobileNumber", 'Numéro de mobile'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "ContactNumber", 'Numéro de téléphone'), "DirectNumber", 'Numéro direct'), "doNotCall", 'Ne pas appeler'), "enterNameOrNumber", 'Nom ou numéro...'), "enterANameOrNumber", 'Saisir un nom ou numéro'), "to", 'À'), "dial", 'Composer'), "message", 'Message'), "transfer", 'Transférer'), "delete", 'Supprimer'), _defineProperty(_HintsType$thirdParty, "invalidPhoneNumber", 'Numéro de téléphone non valide.')); // @key: @#@"[HintsType.thirdPartyNoRecordsContent]"@#@ @source: @#@"Enter at least {minimumLength} characters to search {sourceName} contacts."@#@
