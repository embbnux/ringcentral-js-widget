...
export default {
  [HintsType.thirdPartyNoRecordsContent]:
    'Geben Sie mindestens {minimumLength} Zeichen ein, um {sourceName}-Kontakte zu suchen.',
  ...
  enterNameOrNumber: 'Namen oder Nummern...',
  enterANameOrNumber: 'Namen oder Nummer eingeben',
  to: 'Für',
  dial: 'Wählen',
  message: 'Nachricht',
