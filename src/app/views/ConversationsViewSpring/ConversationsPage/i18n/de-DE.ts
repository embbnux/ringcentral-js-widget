...
export default {
  ...
  cancel: 'Abbrechen',
  byCallQueue: 'Nach Anrufwarteschlange',
  allCallQueues: 'Alle Anrufwarteschlangenleitungen',
  searchCallQueues: 'Anrufwarteschlangen suchen',
  ...
  sendNewTextDisabled: 'Senden neuer SMS deaktiviert',
