...
var _default = exports["default"] = {
  createNewText: 'Crea nuovo SMS',
  createGroupText: 'Crea SMS di gruppo',
  groupTextHint: 'Invia messaggi di testo di gruppo (fino a 10 persone) per avviare una conversazione. O deseleziona la casella per inviare un messaggio di testo a tutti singolarmente; non sapranno che ci sono altri destinatari.',
  optOutSingleRecipient: "Il destinatario ha annullato l'abbonamento.",
  optOutMultipleRecipients: "Alcuni destinatari hanno annullato l'abbonamento.",
  optOutRemove: 'Rimuovi',
  incomingTextsOnly: 'Solo SMS in entrata',
  notSetUpForTexting: 'Non configurato per SMS'
