/* eslint-disable */
export default {
  createNewText: 'Criar nova SMS',
  createGroupText: 'Criar SMS de grupo',
  groupTextHint:
    'Envie SMS em grupo (até 10 pessoas) para iniciar uma conversa de texto. Em alternativa, desmarque a caixa para enviar uma SMS a todos individualmente, sem que tenham conhecimento dos outros destinatários.',
