...
export default {
  ...
  search: 'Saisir un numéro de téléphone',
  filter: 'Filtre',
  filters: 'Filtres',
  reset: 'Réinitialiser',
  cancel: 'Annuler',
  ...
  consentStatusAndCoverage: 'Statut du consentement et de la couverture',
  coverage: 'Couverture',
  company: 'Entreprise',
  ...
  emptyList: 'Aucun numéro inscrit ou désinscrit pour le moment.',
  emptySearch: 'Aucun résultat',
  loadError: 'Impossible de charger les résultats. Veuillez réessayer.',
} as const;
