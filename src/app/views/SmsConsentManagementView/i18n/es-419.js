...
var _default = exports["default"] = {
  ...
  search: 'Ingresar número de teléfono',
  filter: 'Filtrar',
  filters: 'Filtros',
  reset: 'Restablecer',
  cancel: 'Cancelar',
  ...
  consentStatusAndCoverage: 'Estado de consentimiento y cobertura',
  coverage: 'Cobertura',
  company: 'Empresa',
  ...
  emptyList: 'Aún no hay números suscritos o no suscritos.',
  emptySearch: 'No hay resultados de búsqueda',
  loadError: 'No se pudieron cargar los resultados. Inténtelo de nuevo.'
