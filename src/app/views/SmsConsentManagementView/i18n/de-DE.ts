...
export default {
  ...
  consentStatusAndCoverage: 'Einwilligungsstatus und Geltungsbereich',
  coverage: 'Abdeckung',
  company: 'Unternehmen',
  ...
  promotional: 'Werbung',
  emptyList: 'Noch keine angemeldeten oder abgemeldeten Nummern',
