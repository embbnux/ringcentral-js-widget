...
var _default = exports["default"] = {
  ...
  search: 'Insira o número de telefone',
  filter: 'Filtrar',
  filters: 'Filtros',
  reset: 'Restaurar',
  cancel: 'Cancelar',
  ...
  consentStatusAndCoverage: 'Status do consentimento e cobertura',
  coverage: 'Cobertura',
  company: 'Empresa',
  ...
  emptyList: 'Ainda não há números que aceitaram ou recusaram.',
  emptySearch: 'Sem resultados de pesquisa',
  loadError: 'Falha ao carregar os resultados. Tente novamente.'
