/* eslint-disable */
export default {
  title: 'Toestemmingsbeheer',
  search: 'Telefoonnummer invoeren',
  filter: 'Filteren',
  filters: 'Filters',
  reset: 'Terugzetten',
  cancel: 'Annuleren',
  ...
  consentStatusAndCoverage: 'Toestemmingsstatus en dekking',
  coverage: 'Dekking',
  company: 'Bedrijf',
  ...
  emptyList: 'Nog geen aangemelde of afgemelde nummers.',
  emptySearch: 'Geen zoekresultaten',
  loadError: 'Kan resultaten niet laden. Probeer het opnieuw.',
} as const;
