...
export default {
  ...
  optOutAlert: 'De ontvanger heeft zich afgemeld.',
  readOnlyConversationPrefix: 'Dit gesprek is alleen-lezen.',
  smsNotEnabledAlert:
    'Tekstbericht sturen is nog niet ingeschakeld voor dit Account. Neem contact op met uw bedrijfsbeheerder voor meer informatie.',
  smsNoNumberAvailableAlert:
    'Uw nummer(s) kunnen geen sms-berichten verzenden of ontvangen totdat ze door een bedrijfsbeheerder zijn geregistreerd bij Amerikaanse providers.',
  smsReceiveOnlyNumberAlert:
    'Uw nummer(s) is (zijn) ingesteld om inkomende tekstberichten te ontvangen. U kunt geen tekstberichten sturen of beantwoorden.',
  learnMore: 'Meer informatie',
  smsCapabilityAlert:
    'Dit gesprek is alleen-lezen. Uw nummer {phoneNumber} moet door een beheerder worden geregistreerd om sms-berichten te kunnen verzenden.',
  ...
  movedToSharedTabAlert:
    'Het sms-verkeer vanaf het nummer {phoneNumber} is verplaatst naar het tabblad Gedeeld.',
  replyInSharedTab: 'Antwoorden op het tabblad Gedeeld',
  smsConsentRequired:
    'Voor het verzenden van berichten is vereist dat ontvangers toestemming hebben gegeven om berichten te ontvangen.',
  smsConsentRequiredMultipleTitle: 'Bericht geblokkeerd',
  smsConsentRequiredMultiple:
    'Sms’en naar ontvangers die geen toestemming hebben gegeven, is door je beheerder geblokkeerd.',
  addConsent: 'Toestemming toevoegen',
  sharedSmsLogReminder:
    'Zorg ervoor dat u uw berichten registreert voordat u het gesprek afrondt.',
  noAccessToSendFromNumber:
    'U hebt geen toegang meer om vanaf dit nummer berichten te verzenden.',
} as const;
