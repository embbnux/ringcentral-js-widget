...
var _default = exports["default"] = {
  ...
  optOutAlert: '受信者がオプトアウトしました。',
  readOnlyConversationPrefix: 'この会話は読み取り専用です。',
  smsNotEnabledAlert: 'このアカウントではテキストメッセージがまだ有効化されていません。詳細については、貴社の管理者にお問い合わせください。',
  smsNoNumberAvailableAlert: '会社管理者が米国の通信事業者に登録するまで、番号ではSMSを送受信できません。',
  smsReceiveOnlyNumberAlert: 'あなたの番号は、着信テキストメッセージを受信するように設定されています。テキストの送信および返信はできません。',
  learnMore: '詳細を見る',
  smsCapabilityAlert: 'この会話は読み取り専用です。テキストを送信するには、番号 {phoneNumber} を管理者が登録する必要があります。',
  saveLog: 'ログを保存',
  viewInCrm: '{crmName}で表示する',
  createLog: 'ログを作成',
  insertOptOut: 'オプトアウトを挿入',
  removeOptOut: 'オプトアウトを削除',
  movedToSharedTabAlert: '電話番号 {phoneNumber} からのテキストメッセージは共有タブに移動されました。',
  replyInSharedTab: '共有タブで返信',
  smsConsentRequired: 'メッセージを送信するには、受信者がメッセージ受信に同意している必要があります。',
  smsConsentRequiredMultipleTitle: 'メッセージはブロック済み',
  smsConsentRequiredMultiple: 'オプトインしていない受信者へのメッセージ送信は、管理者によってブロックされています。',
  addConsent: '同意を追加',
  sharedSmsLogReminder: '会話を解決する前に、メッセージを必ずログに記録してください。',
  noAccessToSendFromNumber: 'この番号からメッセージを送信する権限がなくなりました。'
