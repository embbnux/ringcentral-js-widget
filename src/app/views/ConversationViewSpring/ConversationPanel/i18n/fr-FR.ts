...
export default {
  ...
  optOutAlert: 'Le destinataire s’est désinscrit.',
  readOnlyConversationPrefix: 'Cette conversation est en lecture seule.',
  smsNotEnabledAlert:
    'La messagerie texte n’est pas encore activée pour ce compte. Veuillez contacter l’administrateur de votre entreprise pour plus d’informations.',
  smsNoNumberAvailableAlert:
    'Vos numéros ne peuvent pas envoyer ni recevoir de SMS tant qu’ils n’ont pas été enregistrés auprès des opérateurs américains par un administrateur de l’entreprise.',
  smsReceiveOnlyNumberAlert:
    'Votre numéro est configuré uniquement pour recevoir des SMS. Vous ne pouvez pas envoyer de SMS ni y répondre.',
  learnMore: 'En savoir plus',
  smsCapabilityAlert:
    'Cette conversation est en lecture seule. Votre numéro {phoneNumber} doit être enregistré par un administrateur pour pouvoir envoyer des SMS.',
  ...
  movedToSharedTabAlert:
    'Les SMS provenant du numéro {phoneNumber} ont été déplacés vers l’onglet Partagé.',
  replyInSharedTab: 'Répondre dans l’onglet Partagé',
  smsConsentRequired:
    'L’envoi de messages nécessite que les destinataires aient donné leur consentement pour les recevoir.',
  smsConsentRequiredMultipleTitle: 'Message bloqué',
  smsConsentRequiredMultiple:
    'L’envoi de SMS à des destinataires qui n’ont pas donné leur consentement est bloqué par votre administrateur.',
  addConsent: 'Ajouter un consentement',
  sharedSmsLogReminder:
    'Assurez-vous d’enregistrer vos messages avant de résoudre la conversation.',
  noAccessToSendFromNumber:
    'Vous n’avez plus l’autorisation d’envoyer des messages depuis ce numéro.',
} as const;
