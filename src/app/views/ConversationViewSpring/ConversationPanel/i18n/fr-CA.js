...
var _default = exports["default"] = {
  ...
  smsNotEnabledAlert: 'La messagerie texte n’est pas encore activée pour ce compte. Veuillez communiquer avec l’administrateur de votre entreprise pour obtenir plus d’informations.',
  smsNoNumberAvailableAlert: 'Vos numéros ne peuvent pas envoyer ni recevoir de messages texte tant qu’ils n’ont pas été enregistrés auprès des opérateurs américains par un administrateur de l’entreprise.',
  smsReceiveOnlyNumberAlert: 'Vos numéros sont configurés pour recevoir les textos entrants. Vous ne pouvez pas envoyer de textos ni y répondre.',
  learnMore: 'En savoir plus',
  smsCapabilityAlert: 'Cette conversation est en lecture seule. Votre numéro {phoneNumber} doit être enregistré par un administrateur pour pouvoir envoyer des textos.',
  ...
  movedToSharedTabAlert: 'Les messages texte provenant du numéro {phoneNumber} ont été déplacés vers l’onglet Partagé.',
  replyInSharedTab: 'Répondre dans l’onglet Partagé',
  smsConsentRequired: 'L’envoi de messages exige que les destinataires aient donné leur consentement pour recevoir des messages.',
  smsConsentRequiredMultipleTitle: 'Message bloqué',
  smsConsentRequiredMultiple: 'L’envoi de messages aux destinataires qui n’ont pas donné leur consentement est bloqué par votre administrateur.',
  addConsent: 'Ajouter un consentement',
  sharedSmsLogReminder: 'Assurez-vous de consigner vos messages avant de résoudre la conversation.',
  noAccessToSendFromNumber: 'Vous n’avez plus accès à l’envoi de messages à partir de ce numéro.'
