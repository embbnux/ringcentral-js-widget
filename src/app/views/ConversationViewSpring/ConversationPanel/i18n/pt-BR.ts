/* eslint-disable */
export default {
  dncAlert: 'Este contato está em uma lista Não ligar.',
  optOutAlert: 'O destinatário recusou o recebimento.',
  readOnlyConversationPrefix: 'Esta conversa é somente leitura.',
  smsNotEnabledAlert:
    'O sistema de mensagem de texto ainda não está habilitado para esta conta. Entre em contato com o administrador da sua empresa para obter mais informações.',
  smsNoNumberAvailableAlert:
    'Seu(s) número(s) não pode(m) enviar nem receber mensagens de texto até que seja(m) registrado(s) junto às operadoras dos EUA por um administrador da empresa.',
  smsReceiveOnlyNumberAlert:
    'Seu(s) número(s) está(ão) configurado(s) para receber mensagens de texto. Não é possível enviar nem responder a mensagens de texto.',
  learnMore: 'Saiba mais',
  smsCapabilityAlert:
    'Esta conversa é somente leitura. Para enviar mensagens de texto, o seu número {phoneNumber} precisa ser registrado por um administrador.',
  saveLog: 'Salvar log',
  viewInCrm: 'Visualizar no {crmName}',
  createLog: 'Criar registro',
  insertOptOut: 'Inserir cancelamento',
  removeOptOut: 'Remover cancelamento',
  movedToSharedTabAlert:
    'As mensagens enviadas do número {phoneNumber} foram movidas para a aba Compartilhada.',
  replyInSharedTab: 'Responder na aba Compartilhado',
  smsConsentRequired:
    'O envio de mensagens exige que os destinatários tenham dado consentimento para receber mensagens.',
  smsConsentRequiredMultipleTitle: 'Bloqueado',
  smsConsentRequiredMultiple:
    'O envio de mensagens para destinatários que não deram consentimento está bloqueado pelo administrador.',
  addConsent: 'Adicionar consentimento',
  sharedSmsLogReminder:
    'Certifique-se de registrar suas mensagens antes de resolver a conversa.',
  noAccessToSendFromNumber:
    'Você não tem mais acesso para enviar mensagens deste número.',
} as const;
