...
var _default = exports["default"] = {
  ...
  optOutAlert: '수신자가 수신 거부했습니다.',
  readOnlyConversationPrefix: '이 대화는 읽기 전용입니다.',
  smsNotEnabledAlert: '이 계정에서는 아직 텍스트 메시징이 활성화되지 않았습니다. 자세한 내용은 회사 관리자에게 문의해 주십시오.',
  smsNoNumberAvailableAlert: '회사 관리자가 미국 통신사에 번호를 등록할 때까지 해당 번호로는 문자 메시지를 보내거나 받을 수 없습니다.',
  smsReceiveOnlyNumberAlert: '번호가 수신 텍스트 메시지를 받도록 설정되어 있습니다. 텍스트를 보내거나 회신할 수 없습니다.',
  learnMore: '자세히 알아보기',
  smsCapabilityAlert: '이 대화는 읽기 전용입니다. 문자 메시지를 보내려면 관리자에 의해 귀하의 번호 {phoneNumber}가 등록되어야 합니다.',
  saveLog: '로그 저장',
  viewInCrm: '{crmName}에서 보기',
  createLog: '기록 만들기',
  insertOptOut: '수신 거부 삽입',
  removeOptOut: '수신 거부 삭제',
  movedToSharedTabAlert: '{phoneNumber} 번호에서의 문자 메시지가 공유 탭으로 이동되었습니다.',
  replyInSharedTab: '공유 탭에서 답장',
  smsConsentRequired: '메시지를 보내려면 수신자가 메시지 수신에 대한 동의를 제공해야 합니다.',
  smsConsentRequiredMultipleTitle: '메시지 차단됨',
  smsConsentRequiredMultiple: '수신자가 수신 동의를 하지 않은 경우, 관리자가 문자 발송을 차단했습니다.',
  addConsent: '동의 추가',
  sharedSmsLogReminder: '대화를 해결하기 전에 메시지가 로그로 기록되었는지 확인하세요.',
  noAccessToSendFromNumber: '더 이상 이 번호로 메시지를 보낼 수 있는 권한이 없습니다.'
