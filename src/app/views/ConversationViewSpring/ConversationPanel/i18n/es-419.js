...
var _default = exports["default"] = {
  ...
  optOutAlert: 'El destinatario canceló la suscripción.',
  readOnlyConversationPrefix: 'Esta conversación es de solo lectura.',
  smsNotEnabledAlert: 'La mensajería de texto aún no está habilitada para esta cuenta. Comuníquese con el administrador de su empresa para obtener más información.',
  smsNoNumberAvailableAlert: 'Sus números no pueden enviar ni recibir mensajes de texto hasta que un administrador de la empresa los registre con las operadoras de Estados Unidos.',
  smsReceiveOnlyNumberAlert: 'Sus números están configurados para recibir mensajes de texto entrantes. No puede enviar mensajes ni responder a ellos',
  learnMore: 'Más información',
  smsCapabilityAlert: 'Esta conversación es de solo lectura. Su número {phoneNumber} debe ser registrado por un administrador para poder enviar mensajes de texto.',
  ...
  movedToSharedTabAlert: 'La función de envío de mensajes desde el número {phoneNumber} se ha movido a la pestaña Compartido.',
  replyInSharedTab: 'Responder en la pestaña Compartido',
  smsConsentRequired: 'Para enviar mensajes, los destinatarios deben haber otorgado su consentimiento para recibirlos.',
  smsConsentRequiredMultipleTitle: 'Bloqueada',
  smsConsentRequiredMultiple: 'El envío de mensajes a destinatarios que no han dado su consentimiento está bloqueado por tu administrador.',
  addConsent: 'Agregar consentimiento',
  sharedSmsLogReminder: 'Asegúrese de registrar sus mensajes antes de resolver la conversación',
  noAccessToSendFromNumber: 'Ya no tiene acceso para enviar mensajes desde este número.'
