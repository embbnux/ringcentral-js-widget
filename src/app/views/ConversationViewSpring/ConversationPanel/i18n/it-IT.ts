...
export default {
  ...
  optOutAlert: 'Il destinatario ha disattivato la ricezione.',
  readOnlyConversationPrefix: 'Questa conversazione è di sola lettura.',
  smsNotEnabledAlert:
    'La messaggistica di testo non è ancora abilitata per questo account. Per ulteriori informazioni, contatti l’amministratore della sua azienda.',
  smsNoNumberAvailableAlert:
    'I Suoi numeri non possono inviare o ricevere messaggi di testo finché non vengono registrati presso gli operatori statunitensi da un amministratore aziendale.',
  smsReceiveOnlyNumberAlert:
    'I tuoi numeri sono impostati per ricevere messaggi di testo in entrata. Non puoi inviare o rispondere agli SMS.',
  learnMore: 'Scopri di più',
  smsCapabilityAlert:
    'Questa conversazione è in sola lettura. Il numero {phoneNumber} deve essere registrato da un amministratore per poter inviare messaggi di testo.',
  saveLog: 'Salva registro',
  viewInCrm: 'Visualizza in {crmName}',
  createLog: 'Crea registro',
  insertOptOut: 'Annulla abbonamento',
  removeOptOut: "Effettua nuovamente l'abbonamento",
  movedToSharedTabAlert:
    'I messaggi inviati dal numero {phoneNumber} sono stati spostati nella scheda Condivisa.',
  replyInSharedTab: 'Rispondi nella scheda Condivisa',
  smsConsentRequired:
    'Per inviare messaggi, è necessario che i destinatari abbiano fornito il consenso a riceverli.',
  smsConsentRequiredMultipleTitle: 'Messaggio bloccato',
  smsConsentRequiredMultiple:
    'L’invio di messaggi ai destinatari che non hanno fornito il consenso è bloccato dall’amministratore.',
  addConsent: 'Aggiungi consenso',
  sharedSmsLogReminder:
    'Si assicuri di registrare i messaggi prima di risolvere la conversazione.',
  noAccessToSendFromNumber:
    "Non dispone più dell'accesso per inviare messaggi da questo numero.",
} as const;
