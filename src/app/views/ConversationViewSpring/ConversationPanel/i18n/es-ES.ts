...
export default {
  ...
  optOutAlert: 'El destinatario ha optado por no participar.',
  readOnlyConversationPrefix: 'Esta conversación es de solo lectura.',
  smsNotEnabledAlert:
    'La mensajería de texto aún no está habilitada para esta cuenta. Póngase en contacto con el administrador de su empresa para obtener más información.',
  smsNoNumberAvailableAlert:
    'Sus números no pueden enviar ni recibir mensajes de texto hasta que un administrador de la empresa los haya registrado ante los operadores de EE. UU.',
  smsReceiveOnlyNumberAlert:
    'Sus números están configurados para recibir mensajes de texto entrantes. No puede enviar ni responder mensajes de texto.',
  learnMore: 'Más información',
  smsCapabilityAlert:
    'Esta conversación es de solo lectura. Su número {phoneNumber} debe ser registrado por un administrador para poder enviar mensajes de texto.',
  saveLog: 'Guardar registro',
  viewInCrm: 'Ver en {crmName}',
  createLog: 'Crear registro',
  insertOptOut: 'Insertar suscripción cancelada',
  removeOptOut: 'Eliminar suscripción cancelada',
  movedToSharedTabAlert:
    'Los mensajes de texto del número {phoneNumber} se han trasladado a la pestaña Compartido.',
  replyInSharedTab: 'Responder en la pestaña Compartido',
  smsConsentRequired:
    'Para enviar mensajes, los destinatarios deben haber dado su consentimiento para recibirlos.',
  smsConsentRequiredMultipleTitle: 'Mensaje bloqueado',
  smsConsentRequiredMultiple:
    'Tu administrador ha bloqueado el envío de mensajes a destinatarios que no hayan dado su consentimiento.',
  addConsent: 'Añadir consentimiento',
  sharedSmsLogReminder:
    'Asegúrese de registrar sus mensajes antes de resolver la conversación.',
  noAccessToSendFromNumber:
    'Ya no tiene acceso para enviar mensajes desde este número.',
} as const;
