...
var _default = exports["default"] = {
  ...
  optOutAlert: 'O destinatário optou por não receber.',
  readOnlyConversationPrefix: 'Esta conversa é apenas de leitura.',
  smsNotEnabledAlert: 'As mensagens de texto ainda não estão ativadas para esta conta. Para mais informações, contacte o administrador da sua empresa.',
  smsNoNumberAvailableAlert: 'Os seus números não podem enviar nem receber mensagens de texto até serem registados junto das operadoras dos EUA por um administrador da empresa.',
  smsReceiveOnlyNumberAlert: 'O(s) seu(s) número(s) está(ão) definido(s) para receber SMS. Não pode enviar nem responder a SMS.',
  learnMore: 'Saber mais',
  smsCapabilityAlert: 'Esta conversa é apenas de leitura. O seu número {phoneNumber} tem de ser registado por um administrador para poder enviar mensagens de texto.',
  ...
  movedToSharedTabAlert: 'A funcionalidade de envio de mensagens a partir do número {phoneNumber} foi transferida para o separador Partilhado.',
  replyInSharedTab: 'Responder no separador Partilhado',
  smsConsentRequired: 'O envio de mensagens requer que os destinatários tenham dado consentimento para receber mensagens.',
  smsConsentRequiredMultipleTitle: 'Mensagem bloqueada',
  smsConsentRequiredMultiple: 'O envio de mensagens para destinatários que não deram consentimento está bloqueado pelo seu administrador.',
  addConsent: 'Adicionar consentimento',
  sharedSmsLogReminder: 'Certifique-se de que regista as suas mensagens antes de resolver a conversa.',
  noAccessToSendFromNumber: 'Já não tem acesso para enviar mensagens a partir deste número.'
