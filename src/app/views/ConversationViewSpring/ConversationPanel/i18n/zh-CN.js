...
var _default = exports["default"] = {
  ...
  optOutAlert: '收件人已退订。',
  readOnlyConversationPrefix: '此对话为只读。',
  smsNotEnabledAlert: '此帐户尚未启用短信功能。请联系您公司的管理员以获取更多信息。',
  smsNoNumberAvailableAlert: '在公司管理员为您的号码向美国运营商完成注册之前，您的号码将无法发送或接收短信。',
  smsReceiveOnlyNumberAlert: '您的号码设置为仅接收短信。您不能发送或回复短信。',
  learnMore: '了解更多',
  smsCapabilityAlert: '此对话为只读状态。您的号码 {phoneNumber} 需要由管理员完成注册后，才能发送短信。',
  saveLog: '保存记录',
  viewInCrm: '在 {crmName} 中查看',
  createLog: '创建记录',
  insertOptOut: '插入退订说明',
  removeOptOut: '删除退订说明',
  movedToSharedTabAlert: '来自号码 {phoneNumber} 的短信已移至“共享”标签页。',
  replyInSharedTab: '前往“共享”标签页回复',
  smsConsentRequired: '发送消息前，接收方必须已同意接收消息。',
  smsConsentRequiredMultipleTitle: '消息已被阻止',
  smsConsentRequiredMultiple: '管理员已阻止向未同意接收短信的收件人发送短信。',
  addConsent: '添加同意',
  sharedSmsLogReminder: '请您在解决或关闭会话之前，务必先记录相关消息。',
  noAccessToSendFromNumber: '您已无权使用此号码发送消息。'
