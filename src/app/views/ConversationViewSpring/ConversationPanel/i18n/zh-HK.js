...
var _default = exports["default"] = {
  ...
  optOutAlert: '收件者已退訂。',
  readOnlyConversationPrefix: '此對話為唯讀。',
  smsNotEnabledAlert: '此帳戶尚未啟用傳送文字訊息功能。請聯絡貴公司的管理員以取得更多資訊。',
  smsNoNumberAvailableAlert: '在公司管理員為您的號碼向美國電信商完成註冊之前，您的號碼將無法傳送或接收簡訊。',
  smsReceiveOnlyNumberAlert: '您的號碼已設定為只可接收簡訊，無法傳送或回覆簡訊。',
  learnMore: '了解更多',
  smsCapabilityAlert: '此對話為唯讀。您的號碼 {phoneNumber} 必須由管理員完成註冊，才能傳送簡訊。',
  saveLog: '儲存記錄',
  viewInCrm: '使用 {crmName} 檢視',
  createLog: '建立記錄',
  insertOptOut: '插入退訂指示',
  removeOptOut: '移除退訂指示',
  movedToSharedTabAlert: '來自號碼 {phoneNumber} 的簡訊已移至 [共用] 標籤頁。',
  replyInSharedTab: '前往 [共用] 標籤頁回覆',
  smsConsentRequired: '發送訊息前，收件人必須已同意接收訊息。',
  smsConsentRequiredMultipleTitle: '訊息已被封鎖',
  smsConsentRequiredMultiple: '管理員已封鎖向未同意接收訊息的收件人發送簡訊。',
  addConsent: '新增同意',
  sharedSmsLogReminder: '請務必在結束對話前先記錄您的訊息。',
  noAccessToSendFromNumber: '您已無法使用此號碼傳送訊息。'
