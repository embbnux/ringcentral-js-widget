...
var _default = exports["default"] = {
  ...
  smsNotEnabledAlert: '此帳戶尚未啟用傳送文字訊息功能。請聯絡貴公司管理員以取得更多資訊。',
  smsNoNumberAvailableAlert: '在公司管理員完成向美國電信業者的註冊之前，您的號碼將無法傳送或接收簡訊。',
  smsReceiveOnlyNumberAlert: '您的號碼設定為僅接收傳入簡訊。您無法傳送或回覆簡訊。',
  learnMore: '瞭解更多',
  smsCapabilityAlert: '此對話為唯讀狀態。您的號碼 {phoneNumber} 必須由管理員完成註冊後，才能傳送簡訊。',
  saveLog: '儲存記錄',
  ...
  replyInSharedTab: '在 [共用] 標籤頁中回覆',
  smsConsentRequired: '傳送訊息前，收件人必須已同意接收訊息。',
  smsConsentRequiredMultipleTitle: '訊息已封鎖',
  smsConsentRequiredMultiple: '管理員已封鎖向未同意接收訊息的收件人發送簡訊。',
  addConsent: '新增同意',
  sharedSmsLogReminder: '請務必在結束對話前先紀錄您的訊息。',
