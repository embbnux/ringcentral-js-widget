...
var _default = exports["default"] = {
  ...
  movedToSharedTabAlert: 'Texting from the number {phoneNumber} has been moved to the Shared tab.',
  replyInSharedTab: 'Reply in Shared tab',
  smsConsentRequired: 'Sending messages requires recipients to have given consent to receive messages.',
  smsConsentRequiredMultipleTitle: 'Message blocked',
  smsConsentRequiredMultiple: 'Texting to recipients who have not opted in is blocked by your admin.',
  addConsent: 'Add consent',
  sharedSmsLogReminder: 'Make sure to log your messages prior to resolving the conversation',
  noAccessToSendFromNumber: 'You no longer have permission to send messages from this number.'
