...
exports.QueueConversationView = void 0;
...
var QUEUE_ACCEPT_FILE_TYPES = process.env.THEME_SYSTEM === 'spring-ui' ? _FileAttacher.SUPPORTED_MMS_MIME_TYPES_IN_LOWERCASE.concat(_FileAttacher.ENHANCED_MMS_MIME_TYPES_IN_LOWERCASE).join() : _FileAttacher.SUPPORTED_MMS_MIME_TYPES_IN_LOWERCASE.join();
var QueueConversationView = exports.QueueConversationView = (_dec = (0, _nextCore.injectable)({
...
}, _dec7 = Reflect.metadata("design:type", Function), _dec8 = Reflect.metadata("design:paramtypes", [typeof _SmsTemplateView.SmsTemplateView === "undefined" ? Object : _SmsTemplateView.SmsTemplateView, typeof _nextCore.PortManager === "undefined" ? Object : _nextCore.PortManager, typeof _services4.QueueMessageStore === "undefined" ? Object : _services4.QueueMessageStore, typeof _services.AppFeatures === "undefined" ? Object : _services.AppFeatures, typeof _services.RegionSettings === "undefined" ? Object : _services.RegionSettings, typeof _services4.QueueConversations === "undefined" ? Object : _services4.QueueConversations, typeof _services.RateLimiter === "undefined" ? Object : _services.RateLimiter, typeof _services.ConnectivityMonitor === "undefined" ? Object : _services.ConnectivityMonitor, typeof _nextCore.RouterPlugin === "undefined" ? Object : _nextCore.RouterPlugin, typeof _services3.IntegrationConfig === "undefined" ? Object : _services3.IntegrationConfig, typeof _services4.SmsConversations === "undefined" ? Object : _services4.SmsConversations, typeof _ConversationsViewSpring.ConversationsViewSpring === "undefined" ? Object : _ConversationsViewSpring.ConversationsViewSpring, typeof _ConversationAlert.ConversationAlert === "undefined" ? Object : _ConversationAlert.ConversationAlert, typeof _services2.ContactMatcher === "undefined" ? Object : _services2.ContactMatcher, typeof ConversationViewSpringOptions === "undefined" ? Object : ConversationViewSpringOptions, typeof SmsConversationsOptions === "undefined" ? Object : SmsConversationsOptions, typeof _SmsOptOutView.SmsOptOutView === "undefined" ? Object : _SmsOptOutView.SmsOptOutView, typeof _services4.SmsConsent === "undefined" ? Object : _services4.SmsConsent]), _dec9 = (0, _nextCore.dynamic)('Theme'), _dec0 = Reflect.metadata("design:type", typeof Theme === "undefined" ? Object : Theme), _dec1 = Reflect.metadata("design:type", Function), _dec10 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = _dec8(_class = (_class2 = /*#__PURE__*/function (_RcViewModule) {
  function QueueConversationView(_smsTemplateView, _portManager, _queueMessageStore, _appFeatures, _regionSettings, _queueConversations, _rateLimiter, _connectivityMonitor, _router, _integrationConfig, _smsConversations, _conversationsViewSpring, _conversationAlert, _contactMatcher, _conversationViewOptions, _smsConversationsOptions, _smsOptOutView, _smsConsent) {
    var _this;
    _classCallCheck(this, QueueConversationView);
    _this = _callSuper(this, QueueConversationView);
  ...
  _inherits(QueueConversationView, _RcViewModule);
  return _createClass(QueueConversationView, [{
    key: "messages",
    get: function get() {
      var conversationId = this._queueConversations.currentConversationId;
      if (!conversationId) {
        return [];
      }
      return this._queueConversations.getMessages(conversationId).sort(function (a, b) {
    ...
    value: function getUIProps(_) {
      ...
      var conversationId = this._queueConversations.currentConversationId;
      var showSpinner = !((!this._contactMatcher || this._contactMatcher.ready) && this._regionSettings.ready && this._queueConversations.ready && this._rateLimiter.ready && this._connectivityMonitor.ready);
      var hasInputContent = this._queueConversations.messageText && this._queueConversations.messageText.length > 0 || this._queueConversations.attachments && this._queueConversations.attachments.length > 0;
      var sending = this._queueConversations.conversationStatus[conversationId] === _services4.conversationsStatus.pushing;
      var conversation = this._queueConversations.formattedConversationsMap.get(conversationId);
    ...
    value: function getUIFunctions(_) {
      ...
      return {
          ...
          var _replyToReceivers = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(text, attachments) {
            ...
            return _regenerator().w(function (_context) {
              while (1) switch (_context.p = _context.n) {
                case 0:
                  currentConversationId = _this3._queueConversations.currentConversationId;
                  ...
                  return _context.a(2);
                case 1:
                  conversation = _this3._queueConversations.formattedConversationsMap.get(currentConversationId);
                ...
                case 3:
                  _context.p = 3;
                  _context.n = 4;
                  return _this3._queueConversations.replyToReceivers(text, attachments);
                case 4:
          ...
          var _updateMessageText = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(text) {
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.n) {
                case 0:
                  _context2.n = 1;
                  return _this3._queueConversations.updateMessageText(text);
                case 1:
        ...
        addAttachments: function addAttachments(attachments) {
          return _this3._queueConversations.addAttachments(attachments);
        },
        removeAttachment: function removeAttachment(attachment) {
          return _this3._queueConversations.removeAttachment(attachment);
        },
    ...
    value: function component(props) {
      ...
      this._router.useParams(function (params) {
        _this4._queueConversations._loadConversation(params.conversationId);
        if (_this4._portManager.shared && _this4._portManager.isMainTab) {
          _this4._queueConversations.loadConversation(params.conversationId);
        }
      });
        ...
        return function () {
          if (_this4._portManager.shared) {
            if (_this4._portManager.isMainTab) {
              _this4._queueConversations.unloadConversation();
            }
          } else {
            _this4._queueConversations.unloadConversation();
          }
      ...
      (0, _react.useEffect)(function () {
        ...
        if (_this4._portManager.shared) {
          if (_this4._portManager.isMainTab) {
            _this4._queueMessageStore.readMessages(conversationId);
          }
        } else {
          _this4._queueMessageStore.readMessages(conversationId);
        }
...
//# sourceMappingURL=QueueConversation.view.js.map
