...
export default {
  ...
  unassignedBannerText:
    "L'assegnazione di questa conversazione è stata annullata.",
  ...
  conversationUnassigned:
    'Assegnazione della conversazione annullata correttamente.',
  ...
  failedToUnassignThread:
    "Impossibile annullare l'assegnazione della conversazione",
} as const;
