...
export interface GeneralMeetingSettingsProps {
  ...
  // Custom props
  isCompact?: boolean; // use compact dialog for edit password dialog
  variant?: 'compact' | 'spacious'; // UI spacing variant: compact for small window, spacious for large window
}
