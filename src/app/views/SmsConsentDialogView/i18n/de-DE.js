...
var _default = exports["default"] = {
  addConsentTitle: 'Einwilligung hinzufügen',
  addConsentSubtitle: 'Verfolgen Sie den An- oder Abmeldestatus des Kontakts für Textnachrichten.',
  consentStatus: 'Einwilligungsstatus',
  optIn: 'Anmelden',
  optOut: 'Abmelden',
  externalNumber: 'Externe Rufnummer',
  smsRegisteredNumber: 'Für SMS registrierte Nummer',
  registrationType: 'Registrierungstyp',
  registrationTypeTooltip: 'Mobilfunkanbieter unterscheiden 3 verschiedene Kategorien von Nachrichten: konversationell, informativ und werblich. Klicken Sie hier, um eine detaillierte Beschreibung zu erhalten:',
  learnMore: 'Mehr erfahren',
  notes: 'Anmerkungen',
  notesPlaceholder: 'Geben Sie Anmerkungen für Ihre Einwilligung ein.',
  save: 'Speichern',
  closeDialog: 'Schließen',
  filterPhoneNumbers: 'Telefonnummern filtern',
  close: 'Schließen',
  enterNumber: 'Nummer eingeben',
  emptySearch: 'Keine Suchergebnisse',
  consentTitle: 'Einwilligung',
  noConsentRecord: 'Der Kontakt hat noch nicht in den Erhalt von SMS-Mitteilungen eingewilligt.',
  addConsent: 'Einwilligung hinzufügen',
  contactGaveConsent: 'Der Kontakt hat eingewilligt, SMS-Mitteilungen zu erhalten.',
  contactOptedOut: 'Der Kontakt hat sich vom Empfang von SMS-Mitteilungen abgemeldet.',
  dateCreated: 'Erstellungsdatum',
  source: 'Quelle',
  coverage: 'Geltungsbereich',
  sourceRecipient: 'Empfänger',
  sourceApi: 'API',
  sourceCarrier: 'Zustellbestätigung',
  sourceAccount: 'Konto',
  coverageNumber: 'Nummer',
  coverageCompany: 'Unternehmen',
  coverageSmsRegistration: 'SMS-Registrierung',
  conversational: 'Konversationsbezogen',
  informational: 'Informativ',
  promotional: 'Werblich',
  optInNumberSummary: 'Der Kontakt hat seine Zustimmung zum Empfang von SMS von {rcNumber} erteilt.',
  optOutNumberSummary: 'Der Kontakt hat den Empfang von SMS von {rcNumber} abgelehnt.',
  campaignIncluded: 'Inbegriffen',
  campaignNotIncluded: 'Nicht inbegriffen',
  unknownUser: 'Unbekannt',
  userAddedConsentNotePrefix: '{userName} hat diese Einwilligung hinzugefügt.',
  saveError: 'Wir haben Probleme, Ihre Einwilligung zu speichern. Bitte versuchen Sie es erneut.',
  openSettingsError: 'Entschuldigung, bei uns ist etwas schiefgelaufen, und wir konnten die Einwilligungsdetails nicht öffnen. Bitte versuchen Sie es später erneut.'
