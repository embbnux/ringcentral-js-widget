...
var _default = exports["default"] = {
  addConsentTitle: '新增同意',
  addConsentSubtitle: '追蹤聯絡人就傳送文字訊息的訂閱或退訂狀態。',
  consentStatus: '同意狀態',
  optIn: '訂閱',
  optOut: '退訂',
  externalNumber: '外部號碼',
  smsRegisteredNumber: '已登記簡訊號碼',
  registrationType: '登記類型',
  registrationTypeTooltip: '行動電訊商將訊息分為 3 種類別：對話型、資訊型及推廣型。按此查看詳細說明：',
  learnMore: '了解更多',
  notes: '備註',
  notesPlaceholder: '請輸入與同意相關的備註。',
  save: '儲存',
  closeDialog: '關閉',
  filterPhoneNumbers: '篩選電話號碼',
  close: '關閉',
  enterNumber: '輸入號碼',
  emptySearch: '無搜尋結果',
  consentTitle: '同意',
  noConsentRecord: '此聯絡人尚未提供接收 SMS 訊息的同意。',
  addConsent: '新增同意',
  contactGaveConsent: '該聯絡人已同意接收短訊通訊。',
  contactOptedOut: '該聯絡人已選擇退出接收短訊通訊。',
  dateCreated: '建立日期',
  source: '來源',
  coverage: '覆蓋範圍',
  sourceRecipient: '收件人',
  ...
  coverageNumber: '號碼',
  coverageCompany: '公司',
  coverageSmsRegistration: '簡訊登記',
  conversational: '對話',
  informational: '資訊',
  promotional: '促銷',
  optInNumberSummary: '該聯絡人已同意接收來自 {rcNumber} 的簡訊。',
  optOutNumberSummary: '該聯絡人已選擇不接收來自 {rcNumber} 的簡訊。',
  campaignIncluded: '包括',
  campaignNotIncluded: '不包括',
  unknownUser: '未知用戶',
  userAddedConsentNotePrefix: '{userName} 已新增此同意。',
  saveError: '我們在儲存您的同意時遇到問題。請再試一次。',
  openSettingsError: '抱歉，我們這邊出現問題，未能開啟同意詳情。請稍後再試。'
