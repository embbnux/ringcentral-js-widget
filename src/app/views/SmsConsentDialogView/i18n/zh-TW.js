...
var _default = exports["default"] = {
  ...
  addConsentSubtitle: '追蹤連絡人訂閱或退訂簡訊的狀態。',
  consentStatus: '同意狀態',
  optIn: '訂閱',
  optOut: '退訂',
  externalNumber: '外部電話號碼',
  smsRegisteredNumber: '簡訊註冊號碼',
  registrationType: '註冊類型',
  registrationTypeTooltip: '行動電信業者將訊息分為 3 種不同類別：對話型、資訊型及推廣型。請點擊此處查看詳細說明：',
  learnMore: '了解更多',
  notes: '筆記',
  notesPlaceholder: '輸入同意備註。',
  save: '儲存',
  closeDialog: '關閉',
  ...
  emptySearch: '無搜尋結果',
  consentTitle: '同意',
  noConsentRecord: '該連絡人尚未同意接收簡訊。',
  addConsent: '新增同意',
  contactGaveConsent: '該連絡人已同意接收簡訊。',
  contactOptedOut: '該連絡人已選擇退訂簡訊。',
  dateCreated: '建立日期',
  source: '來源',
  coverage: '適用範圍',
  sourceRecipient: '收件者',
  ...
  coverageNumber: '號碼',
  coverageCompany: '公司',
  coverageSmsRegistration: '簡訊註冊',
  conversational: '對話',
  informational: '資訊',
  promotional: '促銷',
  optInNumberSummary: '該聯絡人已同意接收來自 {rcNumber} 的簡訊。',
  optOutNumberSummary: '該聯絡人已拒絕接收來自 {rcNumber} 的簡訊。',
  campaignIncluded: '已包含',
  campaignNotIncluded: '未包含',
  unknownUser: '未知使用者',
  userAddedConsentNotePrefix: '{userName} 新增了此同意。',
  saveError: '儲存您的同意狀態時發生問題。請再試一次。',
  openSettingsError: '很抱歉，我們這邊發生了問題，導致無法開啟同意詳情。請稍後再試。'
