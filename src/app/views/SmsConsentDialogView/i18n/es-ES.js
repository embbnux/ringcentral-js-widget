...
var _default = exports["default"] = {
  addConsentTitle: 'Añadir consentimiento',
  addConsentSubtitle: 'Realice un seguimiento del estado de suscripción o exclusión del contacto para la mensajería de texto.',
  ...
  registrationTypeTooltip: 'Los operadores móviles identifican 3 categorías diferentes de mensajes: Conversacional, Informativo y Promocional. Haga clic aquí para ver una descripción detallada:',
  learnMore: 'Más información',
  notes: 'Notas',
  notesPlaceholder: 'Introduzca notas para su consentimiento.',
  save: 'Guardar',
  closeDialog: 'Cerrar',
  ...
  noConsentRecord: 'El contacto aún no ha proporcionado su consentimiento para recibir comunicaciones por SMS.',
  addConsent: 'Añadir consentimiento',
  contactGaveConsent: 'El contacto dio su consentimiento para recibir comunicaciones por SMS.',
  contactOptedOut: 'El contacto ha decidido no recibir comunicaciones por SMS.',
  dateCreated: 'Fecha de creación',
  source: 'Origen',
  coverage: 'Cobertura',
  sourceRecipient: 'Destinatario',
  sourceApi: 'API',
  sourceCarrier: 'Confirmación de entrega',
  ...
  optOutNumberSummary: 'El contacto revocó su consentimiento para recibir SMS desde {rcNumber}.',
  campaignIncluded: 'Incluido',
  campaignNotIncluded: 'No incluido',
  unknownUser: 'Usuario desconocido',
  userAddedConsentNotePrefix: '{userName} añadió este consentimiento.',
  saveError: 'Se ha producido un problema al guardar su consentimiento. Inténtelo de nuevo.',
  openSettingsError: 'Lo sentimos, se produjo un error por nuestra parte y no fue posible abrir los detalles del consentimiento. Inténtelo de nuevo más tarde.'
