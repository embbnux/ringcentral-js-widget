...
export default {
  ...
  addConsentSubtitle:
    'Monitorize o estado de aceitação ou recusa de mensagens de texto por parte do contacto.',
  ...
  registrationTypeTooltip:
    'As operadoras móveis identificam 3 categorias diferentes de mensagens: conversacionais, informativas e promocionais. Clique aqui para ver uma descrição detalhada:',
  ...
  noConsentRecord:
    'O contato ainda não forneceu consentimento para receber comunicações por SMS.',
  addConsent: 'Adicionar consentimento',
  contactGaveConsent:
    'O contacto deu consentimento para receber comunicações por SMS.',
  ...
  optInNumberSummary:
    'O contacto deu consentimento para receber SMS de {rcNumber}.',
  ...
  saveError:
    'Estamos a ter problemas a guardar o seu consentimento. Tente novamente.',
  openSettingsError:
    'Lamentamos, ocorreu um erro do nosso lado e não foi possível abrir os detalhes do consentimento. Tente novamente mais tarde.',
} as const;
