...
var _default = exports["default"] = {
  addConsentTitle: 'Toestemming toevoegen',
  addConsentSubtitle: 'Houd de aan- of afmeldingsstatus van de contactpersoon voor tekstberichten bij.',
  consentStatus: 'Toestemmingsstatus',
  optIn: 'Aanmelden',
  optOut: 'Afmelden',
  externalNumber: 'Extern nummer',
  smsRegisteredNumber: 'Geregistreerd sms-nummer',
  registrationType: 'Registratietype',
  registrationTypeTooltip: 'Mobiele providers onderscheiden 3 verschillende categorieën berichten: conversationeel, informatief en promotioneel. Klik hier voor een gedetailleerde beschrijving:',
  learnMore: 'Meer informatie',
  notes: 'Notities',
  notesPlaceholder: 'Voer notities in voor uw toestemming.',
  save: 'Opslaan',
  closeDialog: 'Sluiten',
  filterPhoneNumbers: 'Telefoonnummers filteren',
  close: 'Sluiten',
  enterNumber: 'Voer een nummer in',
  emptySearch: 'Geen zoekresultaten',
  consentTitle: 'Toestemming',
  noConsentRecord: 'De contactpersoon heeft nog geen toestemming gegeven voor het ontvangen van sms-communicatie.',
  addConsent: 'Toestemming toevoegen',
  contactGaveConsent: 'De contactpersoon heeft toestemming gegeven om sms-communicatie te ontvangen.',
  contactOptedOut: 'De contactpersoon heeft zich afgemeld voor het ontvangen van sms-communicatie.',
  dateCreated: 'Aanmaakdatum',
  source: 'Bron',
  coverage: 'Dekking',
  sourceRecipient: 'Ontvanger',
  sourceApi: 'API',
  sourceCarrier: 'Afleverbevestiging',
  sourceAccount: 'Account',
  coverageNumber: 'Nummer',
  coverageCompany: 'Bedrijf',
  coverageSmsRegistration: 'SMS-registratie',
  conversational: 'Conversationeel',
  informational: 'Informatief',
  promotional: 'Promotioneel',
  optInNumberSummary: 'De contactpersoon heeft toestemming gegeven om sms-berichten te ontvangen van {rcNumber}.',
  optOutNumberSummary: 'De contactpersoon heeft zich afgemeld voor het ontvangen van sms-berichten van {rcNumber}.',
  campaignIncluded: 'Inbegrepen',
  campaignNotIncluded: 'Niet inbegrepen',
  unknownUser: 'Onbekend',
  userAddedConsentNotePrefix: '{userName} heeft deze toestemming toegevoegd.',
  saveError: 'Het lukt ons niet om uw toestemming op te slaan. Probeer het opnieuw.',
  openSettingsError: 'Sorry, er is aan onze kant iets misgegaan en we konden de toestemmingsgegevens niet openen. Probeer het later opnieuw.'
