...
var _default = exports["default"] = {
  addConsentTitle: '同意を追加',
  addConsentSubtitle: 'テキストメッセージのオプトインまたはオプトアウトに関する連絡先のステータスを追跡します。',
  consentStatus: '同意ステータス',
  optIn: 'オプトイン',
  optOut: 'オプトアウト',
  externalNumber: '外部番号',
  smsRegisteredNumber: 'SMS登録番号',
  registrationType: '登録タイプ',
  registrationTypeTooltip: 'モバイル通信事業者は、メッセージを「会話型」「情報提供型」「プロモーション型」の3つのカテゴリに分類しています。詳しい説明については、こちらをクリックしてください。',
  learnMore: '詳細を見る',
  notes: 'メモ',
  notesPlaceholder: '同意に関するメモを入力してください。',
  save: '保存',
  closeDialog: '閉じる',
  filterPhoneNumbers: '電話番号をフィルタリング',
  close: '閉じる',
  enterNumber: '番号を入力',
  emptySearch: '検索結果はありません',
  consentTitle: '同意',
  noConsentRecord: '連絡先はまだ、SMSを受信することを承諾していません。',
  addConsent: '同意を追加',
  contactGaveConsent: '連絡先がSMS通信を受信することに同意しました。',
  contactOptedOut: '連絡先はSMS通信の受信をオプトアウトしました。',
  dateCreated: '作成日',
  source: 'ソース',
  coverage: '適用範囲',
  sourceRecipient: '受信者',
  ...
  coverageNumber: '番号',
  coverageCompany: '会社',
  coverageSmsRegistration: 'SMS登録',
  conversational: '会話',
  informational: '情報',
  promotional: 'プロモーション',
  optInNumberSummary: '連絡先は {rcNumber} からの SMS 受信に同意しました。',
  optOutNumberSummary: '連絡先は {rcNumber} からの SMS 受信を停止しました。',
  campaignIncluded: '含まれています',
  campaignNotIncluded: '含まれていません',
  unknownUser: '不明なユーザー',
  userAddedConsentNotePrefix: '{userName} がこの同意を追加しました。',
  saveError: '同意を保存する際に問題が発生しました。もう一度お試しください。',
  openSettingsError: '申し訳ありません。こちらの問題により、同意の詳細を開くことができませんでした。しばらくしてから再度お試しください。'
