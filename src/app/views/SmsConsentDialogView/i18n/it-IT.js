...
var _default = exports["default"] = {
  addConsentTitle: 'Aggiungi consenso',
  addConsentSubtitle: 'Tieni traccia dello stato di conferma o annullamento abbonamento del contatto per i messaggi di testo.',
  consentStatus: 'Stato del consenso',
  optIn: 'Conferma abbonamento',
  optOut: 'Annulla abbonamento',
  externalNumber: 'Numero esterno',
  smsRegisteredNumber: 'Numero registrato per gli SMS',
  registrationType: 'Tipo di registrazione',
  registrationTypeTooltip: 'Gli operatori di telefonia mobile identificano 3 diverse categorie di messaggi: conversazionali, informativi e promozionali. Clicchi qui per una descrizione dettagliata:',
  learnMore: 'Scopri di più',
  notes: 'Note',
  notesPlaceholder: 'Inserisci le note per il consenso.',
  save: 'Salva',
  closeDialog: 'Chiudi',
  filterPhoneNumbers: 'Filtra i numeri di telefono',
  close: 'Chiudi',
  enterNumber: 'Inserisci il numero',
  emptySearch: 'La ricerca non ha prodotto risultati',
  consentTitle: 'Consenso',
  noConsentRecord: 'Il contatto non ha ancora fornito il consenso a ricevere comunicazioni SMS.',
  addConsent: 'Aggiungi consenso',
  contactGaveConsent: 'Il contatto ha fornito il consenso a ricevere comunicazioni SMS.',
  contactOptedOut: 'Il contatto ha scelto di non ricevere comunicazioni SMS.',
  dateCreated: 'Data di creazione',
  source: 'Origine',
  coverage: 'Copertura',
  sourceRecipient: 'Destinatario',
  sourceApi: 'API',
  sourceCarrier: 'Ricevuta di consegna',
  sourceAccount: 'Account',
  coverageNumber: 'Numero',
  coverageCompany: 'Azienda',
  coverageSmsRegistration: 'Registrazione SMS',
  conversational: 'Conversazionale',
  informational: 'Informativo',
  promotional: 'Promozionale',
  optInNumberSummary: 'Il contatto ha fornito il consenso a ricevere SMS da {rcNumber}.',
  optOutNumberSummary: 'Il contatto ha revocato il consenso a ricevere SMS da {rcNumber}.',
  campaignIncluded: 'Incluso',
  campaignNotIncluded: 'Non incluso',
  unknownUser: 'Sconosciuto',
  userAddedConsentNotePrefix: '{userName} ha aggiunto questo consenso.',
  saveError: 'Si è verificato un problema durante il salvataggio del consenso. Riprova.',
  openSettingsError: 'Siamo spiacenti, si è verificato un problema da parte nostra e non è stato possibile aprire i dettagli del consenso. Riprovi più tardi.'
