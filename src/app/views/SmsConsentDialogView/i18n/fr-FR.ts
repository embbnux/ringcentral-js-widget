...
export default {
  ...
  addConsentSubtitle:
    'Suivez le statut d’inscription ou de désinscription du contact pour la messagerie texte.',
  ...
  registrationTypeTooltip:
    'Les opérateurs mobiles identifient 3 catégories de messages : conversationnels, informatifs et promotionnels. Cliquez ici pour consulter une description détaillée :',
  ...
  noConsentRecord:
    'Le contact n’a pas encore donné son accord pour recevoir des communications par SMS.',
  addConsent: 'Ajouter un consentement',
  contactGaveConsent:
    'Le contact a accepté de recevoir des communications par SMS.',
  ...
  optInNumberSummary:
    'Le contact a donné son consentement pour recevoir des SMS depuis {rcNumber}.',
  optOutNumberSummary:
    'Le contact s’est désinscrit de la réception de SMS depuis {rcNumber}.',
  campaignIncluded: 'Inclus',
  campaignNotIncluded: 'Non inclus',
  unknownUser: 'Inconnu',
  userAddedConsentNotePrefix: '{userName} a ajouté ce consentement.',
  saveError:
    'Nous rencontrons des difficultés pour enregistrer votre consentement. Veuillez réessayer.',
  openSettingsError:
    'Désolé, un problème est survenu de notre côté et nous n’avons pas pu ouvrir les détails du consentement. Veuillez réessayer ultérieurement.',
} as const;
