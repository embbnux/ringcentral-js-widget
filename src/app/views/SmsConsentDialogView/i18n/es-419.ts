...
export default {
  ...
  addConsentSubtitle:
    'Realice un seguimiento del estado de suscripción o cancelación de suscripción del contacto para la mensajería de texto.',
  ...
  registrationTypeTooltip:
    'Los operadores móviles identifican 3 categorías diferentes de mensajes: conversacionales, informativos y promocionales. Haga clic aquí para ver una descripción detallada:',
  ...
  noConsentRecord:
    'El contacto aún no otorgó su consentimiento para recibir comunicaciones por SMS.',
  addConsent: 'Agregar consentimiento',
  contactGaveConsent:
    'El contacto otorgó su consentimiento para recibir comunicaciones por SMS.',
  ...
  optInNumberSummary:
    'El contacto dio su consentimiento para recibir SMS desde {rcNumber}.',
  optOutNumberSummary:
    'El contacto canceló su suscripción para recibir SMS desde {rcNumber}.',
  ...
  saveError:
    'Tenemos problemas para guardar su consentimiento. Vuelva a intentarlo.',
  openSettingsError:
    'Lo sentimos, ocurrió un error de nuestro lado y no pudimos abrir los detalles del consentimiento. Inténtelo de nuevo más tarde.',
} as const;
