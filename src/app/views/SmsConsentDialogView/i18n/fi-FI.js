...
var _default = exports["default"] = {
  addConsentTitle: 'Lisää suostumus',
  addConsentSubtitle: 'Seuraa yhteyshenkilön tekstiviestien tilaamisen tai peruuttamisen tilaa.',
  consentStatus: 'Suostumuksen tila',
  optIn: 'Tilaa',
  optOut: 'Peruuta tilaus',
  externalNumber: 'Ulkoinen numero',
  smsRegisteredNumber: 'Tekstiviestirekisteröity numero',
  registrationType: 'Rekisteröintityyppi',
  registrationTypeTooltip: 'Mobiilioperaattorit tunnistavat 3 erilaista viestiluokkaa: keskustelullinen, tiedottava ja markkinointiviesti. Napsauta tästä nähdäksesi yksityiskohtaisen kuvauksen:',
  learnMore: 'Lisätietoja',
  notes: 'Muistiinpanot',
  notesPlaceholder: 'Voit antaa suostumukseesi liittyviä huomautuksia.',
  save: 'Tallenna',
  closeDialog: 'Sulje',
  filterPhoneNumbers: 'Suodata puhelinnumerot',
  close: 'Sulje',
  enterNumber: 'Anna numero',
  emptySearch: 'Ei hakutuloksia',
  consentTitle: 'Suostumus',
  noConsentRecord: 'Yhteystieto ei ole vielä antanut suostumusta tekstiviestien vastaanottamiselle.',
  addConsent: 'Lisää suostumus',
  contactGaveConsent: 'Yhteystieto antoi suostumuksen vastaanottaa tekstiviestejä.',
  contactOptedOut: 'Yhteystieto peruutti suostumuksensa tekstiviestien vastaanottamiseen.',
  dateCreated: 'Luontipäivä',
  source: 'Lähde',
  coverage: 'Kattavuus',
  sourceRecipient: 'Vastaanottaja',
  sourceApi: 'API',
  sourceCarrier: 'Toimituskuittaus',
  sourceAccount: 'Tili',
  coverageNumber: 'Numero',
  coverageCompany: 'Yritys',
  coverageSmsRegistration: 'SMS-rekisteröinti',
  conversational: 'Keskustelu',
  informational: 'Tiedot',
  promotional: 'Mainos',
  optInNumberSummary: 'Yhteyshenkilö antoi suostumuksensa vastaanottaa SMS-viestejä numerosta {rcNumber}.',
  optOutNumberSummary: 'Yhteyshenkilö kieltäytyi vastaanottamasta SMS-viestejä numerosta {rcNumber}.',
  campaignIncluded: 'Sisältyy',
  campaignNotIncluded: 'Ei sisälly',
  unknownUser: 'Tuntematon käyttäjä',
  userAddedConsentNotePrefix: '{userName} lisäsi tämän suostumuksen.',
  saveError: 'Suostumuksen tallentamisessa ilmeni ongelma. Yritä uudelleen.',
  openSettingsError: 'Pahoittelemme, että palvelussamme tapahtui virhe emmekä pystyneet avaamaan suostumuksen tietoja. Yritä myöhemmin uudelleen.'
