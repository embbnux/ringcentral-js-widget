...
var _default = exports["default"] = {
  ...
  addConsentSubtitle: 'Acompanhe o status de consentimento ou recusa do contato para mensagens de texto.',
  consentStatus: 'Status do consentimento',
  optIn: 'Consentir',
  optOut: 'Recusar',
  externalNumber: 'Número externo',
  smsRegisteredNumber: 'Número registrado para SMS',
  registrationType: 'Tipo de registro',
  registrationTypeTooltip: 'As operadoras móveis identificam 3 categorias diferentes de mensagens: conversacionais, informativas e promocionais. Clique aqui para obter uma descrição detalhada:',
  learnMore: 'Saiba mais',
  notes: 'Observações',
  notesPlaceholder: 'Insira anotações para o seu consentimento.',
  save: 'Salvar',
  closeDialog: 'Fechar',
  ...
  contactGaveConsent: 'O contato forneceu consentimento para receber comunicações por SMS.',
  contactOptedOut: 'O contato recusou o recebimento de comunicações por SMS.',
  ...
  optInNumberSummary: 'O contato deu consentimento para receber SMS de {rcNumber}.',
  optOutNumberSummary: 'O contato optou por não receber SMS de {rcNumber}.',
  ...
  saveError: 'Estamos com problemas para salvar seu consentimento. Tente novamente.',
  openSettingsError: 'Desculpe, ocorreu um erro do nosso lado e não foi possível abrir os detalhes de consentimento. Tente novamente mais tarde.'
