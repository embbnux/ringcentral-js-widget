...
var _default = exports["default"] = {
  addConsentTitle: 'Ajouter un consentement',
  addConsentSubtitle: 'Suivez le statut d’inscription ou de désinscription du contact pour la messagerie texte.',
  consentStatus: 'Statut du consentement',
  optIn: 'Inscription',
  optOut: 'Désinscription',
  externalNumber: 'Numéro externe',
  smsRegisteredNumber: 'Numéro SMS enregistré',
  registrationType: 'Type d’inscription',
  registrationTypeTooltip: 'Les opérateurs mobiles identifient 3 catégories de messages : conversationnels, informatifs et promotionnels. Cliquez ici pour consulter une description détaillée :',
  learnMore: 'En savoir plus',
  notes: 'Notes',
  notesPlaceholder: 'Saisissez les notes pour votre consentement.',
  save: 'Enregistrer',
  closeDialog: 'Fermer',
  filterPhoneNumbers: 'Filtrer les numéros de téléphone',
  close: 'Fermer',
  enterNumber: 'Saisir un numéro',
  emptySearch: 'Aucun résultat',
  consentTitle: 'Consentement',
  noConsentRecord: 'Le contact n’a pas encore donné son accord pour recevoir des communications par SMS.',
  addConsent: 'Ajouter un consentement',
  contactGaveConsent: 'Le contact a accepté de recevoir des communications par SMS.',
  contactOptedOut: 'Le contact s’est désinscrit des communications par SMS.',
  dateCreated: 'Date de création',
  source: 'Source',
  coverage: 'Couverture',
  sourceRecipient: 'Destinataire',
  sourceApi: 'API',
  sourceCarrier: 'Accusé de réception',
  sourceAccount: 'Compte',
  coverageNumber: 'Numéro',
  coverageCompany: 'Entreprise',
  coverageSmsRegistration: 'Inscription SMS',
  conversational: 'Conversationnel',
  informational: 'Informationnel',
  promotional: 'Promotionnel',
  optInNumberSummary: 'Le contact a donné son consentement pour recevoir des SMS depuis {rcNumber}.',
  optOutNumberSummary: 'Le contact s’est désinscrit de la réception de SMS depuis {rcNumber}.',
  campaignIncluded: 'Inclus',
  campaignNotIncluded: 'Non inclus',
  unknownUser: 'Inconnu',
  userAddedConsentNotePrefix: '{userName} a ajouté ce consentement.',
  saveError: 'Nous rencontrons des difficultés pour enregistrer votre consentement. Veuillez réessayer.',
  openSettingsError: 'Désolé, un problème est survenu de notre côté et nous n’avons pas pu ouvrir les détails du consentement. Veuillez réessayer ultérieurement.'
