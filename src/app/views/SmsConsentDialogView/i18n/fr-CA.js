...
var _default = exports["default"] = {
  ...
  addConsentSubtitle: 'Suivez l’état d’inscription ou de désinscription du contact pour la messagerie texte.',
  consentStatus: 'Statut du consentement',
  optIn: 'S’inscrire',
  optOut: 'Se désinscrire',
  externalNumber: 'Numéro externe',
  smsRegisteredNumber: 'Numéro enregistré pour les SMS',
  registrationType: 'Type d’inscription',
  registrationTypeTooltip: 'Les opérateurs mobiles identifient 3 catégories de messages : conversationnels, informationnels et promotionnels. Cliquez ici pour une description détaillée :',
  ...
  noConsentRecord: 'Le contact n’a pas encore accepté de recevoir des communications par SMS.',
  addConsent: 'Ajouter un consentement',
  contactGaveConsent: 'Le contact a accepté de recevoir des communications par SMS.',
  contactOptedOut: 'Le contact a choisi de ne pas recevoir de communications par SMS.',
  ...
  optInNumberSummary: 'Le contact a donné son consentement pour recevoir des SMS de {rcNumber}.',
  optOutNumberSummary: 'Le contact s’est désabonné de la réception de SMS de {rcNumber}.',
  campaignIncluded: 'Inclus',
  campaignNotIncluded: 'Non inclus',
  unknownUser: 'Utilisateur inconnu',
  userAddedConsentNotePrefix: '{userName} a ajouté ce consentement.',
  saveError: 'Nous éprouvons des difficultés à enregistrer votre consentement. Veuillez réessayer.',
  openSettingsError: 'Désolé, un problème est survenu de notre côté et nous n’avons pas pu ouvrir les détails du consentement. Veuillez réessayer plus tard.'
