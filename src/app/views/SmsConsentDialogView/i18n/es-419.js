...
var _default = exports["default"] = {
  addConsentTitle: 'Agregar consentimiento',
  addConsentSubtitle: 'Realice un seguimiento del estado de suscripción o cancelación de suscripción del contacto para la mensajería de texto.',
  consentStatus: 'Estado del consentimiento',
  optIn: 'Suscribirse',
  optOut: 'Cancelar la suscripción',
  externalNumber: 'Número externo',
  smsRegisteredNumber: 'Número registrado de SMS',
  registrationType: 'Tipo de registro',
  registrationTypeTooltip: 'Los operadores móviles identifican 3 categorías diferentes de mensajes: conversacionales, informativos y promocionales. Haga clic aquí para ver una descripción detallada:',
  learnMore: 'Más información',
  notes: 'Notas',
  notesPlaceholder: 'Ingrese notas de su consentimiento.',
  save: 'Guardar',
  closeDialog: 'Cerrar',
  filterPhoneNumbers: 'Filtrar números de teléfono',
  close: 'Cerrar',
  enterNumber: 'Ingrese el número',
  emptySearch: 'No hay resultados de búsqueda',
  consentTitle: 'Consentimiento',
  noConsentRecord: 'El contacto aún no otorgó su consentimiento para recibir comunicaciones por SMS.',
  addConsent: 'Agregar consentimiento',
  contactGaveConsent: 'El contacto otorgó su consentimiento para recibir comunicaciones por SMS.',
  contactOptedOut: 'El contacto decidió no recibir comunicaciones por SMS.',
  dateCreated: 'Fecha de creación',
  source: 'Origen',
  coverage: 'Cobertura',
  sourceRecipient: 'Destinatario',
  sourceApi: 'API',
  sourceCarrier: 'Acuse de entrega',
  sourceAccount: 'Cuenta',
  coverageNumber: 'Número',
  coverageCompany: 'Empresa',
  coverageSmsRegistration: 'Registro de SMS',
  conversational: 'Conversacional',
  informational: 'Informativo',
  promotional: 'Promocional',
  optInNumberSummary: 'El contacto dio su consentimiento para recibir SMS desde {rcNumber}.',
  optOutNumberSummary: 'El contacto canceló su suscripción para recibir SMS desde {rcNumber}.',
  campaignIncluded: 'Incluido',
  campaignNotIncluded: 'No incluido',
  unknownUser: 'Usuario desconocido',
  userAddedConsentNotePrefix: '{userName} agregó este consentimiento.',
  saveError: 'Tenemos problemas para guardar su consentimiento. Vuelva a intentarlo.',
  openSettingsError: 'Lo sentimos, ocurrió un error de nuestro lado y no pudimos abrir los detalles del consentimiento. Inténtelo de nuevo más tarde.'
