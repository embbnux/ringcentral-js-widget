...
export default {
  ...
  addConsentSubtitle:
    '텍스트 메시징에 대한 연락처의 수신 동의 또는 수신 거부 상태를 추적합니다.',
  consentStatus: '동의 상태',
  optIn: '수신 동의',
  optOut: '수신 거부',
  ...
  registrationTypeTooltip:
    '이동통신사는 메시지를 3가지 유형으로 분류합니다: 대화형, 정보성, 프로모션. 자세한 설명을 보려면 여기를 클릭하세요:',
  learnMore: '자세히 알아보기',
  notes: '노트',
  ...
  promotional: '프로모션',
  optInNumberSummary:
    '해당 연락처는 {rcNumber}에서 발송되는 SMS 수신에 동의했습니다.',
  optOutNumberSummary:
    '해당 연락처는 {rcNumber}에서 발송되는 SMS 수신을 거부했습니다.',
  ...
  openSettingsError:
    '죄송합니다. 시스템 오류로 인해 동의 세부 정보를 열 수 없습니다. 잠시 후 다시 시도해 주세요.',
} as const;
