...
var ExtensionPhoneNumber = exports.ExtensionPhoneNumber = (_dec = (0, _nextCore.injectable)({
  ...
  return _createClass(ExtensionPhoneNumber, [{
    ...
    value: function onInitOnce() {
      var _this2 = this;
      _superPropGet(ExtensionPhoneNumber, "onInitOnce", this, 3)([]);
      var subscription = this._subscription;
      if (!subscription) return;
      var watchChange$ = (0, _rxjs.merge)(subscription.fromMessage$(/.*\/extension\/\d+$/).pipe((0, _rxjs.filter)(function (body) {
        var _body$hints;
        return Boolean((_body$hints = body.hints) === null || _body$hints === void 0 ? void 0 : _body$hints.includes(_subscriptionHints.subscriptionHints.companyNumbers));
      })),
      ...
      subscription.fromMessage$(/\/extension\/.*.\/grant/)).pipe((0, _rxjs.tap)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 2:
              _context2.p = 2;
              _t = _context2.v;
              _this2.logger.error('extension phone number update error', _t);
            case 3:
      ...
      this.readyState$.pipe((0, _rxjs.switchMap)(function (ready) {
        return ready ? watchChange$ : _rxjs.EMPTY;
      })).subscribe();
    }
  }, {
    key: "numbers",
    ...
    key: "companyNumbers",
    get: function get() {
      return this.numbers.filter(function (phoneNumber) {
    ...
    get: function get() {
      return this.numbers.filter(function (_ref2) {
        var type = _ref2.type;
        return !!type && ['FaxOnly', 'VoiceFax'].includes(type);
      });
    }
  }]);
}(_DataFetcher.DataFetcherConsumer), _applyDecoratedDescriptor(_class2.prototype, "numbers", [_nextCore.computed, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "numbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "companyNumbers", [_nextCore.computed, _dec8, _dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "companyNumbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mainCompanyNumber", [_nextCore.computed, _dec0, _dec1], Object.getOwnPropertyDescriptor(_class2.prototype, "mainCompanyNumber"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "directNumbers", [_nextCore.computed, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "directNumbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "callerIdNumbers", [_nextCore.computed, _dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "callerIdNumbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "primaryNumber", [_nextCore.computed, _dec14, _dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "primaryNumber"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "smsSenderNumbers", [_nextCore.computed, _dec16, _dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "smsSenderNumbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "faxSenderNumbers", [_nextCore.computed, _dec18, _dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "faxSenderNumbers"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class) || _class);
