...
var _loadMixpanel = require("./loadMixpanel");
    ...
    (0, _rxjs.take)(1), (0, _rxjs.switchMap)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.n = 1;
            return (0, _loadMixpanel.loadMixpanel)();
          case 1:
            mixpanel = _context.v;
          ...
          if (enableMixpanel) {
            ...
            return authModule$.pipe((0, _rxjs.switchMap)(function (auth) {
              ...
              if (!ownerId) {
                ...
                if ((_mixpanel$get_distinc = mixpanel.get_distinct_id) !== null && _mixpanel$get_distinc !== void 0 && _mixpanel$get_distinc.call(mixpanel)) {
