...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec0, _dec1, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7;
...
var WebSocketSubscription = exports.WebSocketSubscription = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('WebSocketSubscriptionOptions')(target, undefined, 4);
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _Client.Client === "undefined" ? Object : _Client.Client, typeof _nextCore.StoragePlugin === "undefined" ? Object : _nextCore.StoragePlugin, typeof _RingCentralExtensions.RingCentralExtensions === "undefined" ? Object : _RingCentralExtensions.RingCentralExtensions, typeof _services.SleepDetector === "undefined" ? Object : _services.SleepDetector, typeof WebSocketSubscriptionOptions === "undefined" ? Object : WebSocketSubscriptionOptions]), _dec6 = (0, _nextCore.dynamic)('BrowserLogger'), _dec7 = Reflect.metadata("design:type", typeof BrowserLogger === "undefined" ? Object : BrowserLogger), _dec8 = Reflect.metadata("design:type", typeof SubscriptionInfo === "undefined" ? Object : SubscriptionInfo), _dec9 = Reflect.metadata("design:type", String), _dec0 = Reflect.metadata("design:type", Function), _dec1 = Reflect.metadata("design:paramtypes", [Boolean]), _dec10 = Reflect.metadata("design:type", Function), _dec11 = Reflect.metadata("design:paramtypes", [typeof SubscriptionInfo === "undefined" ? Object : SubscriptionInfo, String]), _dec12 = (0, _nextCore.delegate)('server'), _dec13 = Reflect.metadata("design:type", Function), _dec14 = Reflect.metadata("design:paramtypes", []), _dec15 = Reflect.metadata("design:type", Function), _dec16 = Reflect.metadata("design:paramtypes", [Object]), _dec17 = Reflect.metadata("design:type", Function), _dec18 = Reflect.metadata("design:paramtypes", []), _dec19 = Reflect.metadata("design:type", Array), _dec20 = (0, _nextCore.delegate)('server'), _dec21 = Reflect.metadata("design:type", Function), _dec22 = Reflect.metadata("design:paramtypes", [Array]), _dec23 = (0, _nextCore.delegate)('server'), _dec24 = Reflect.metadata("design:type", Function), _dec25 = Reflect.metadata("design:paramtypes", [Array]), _dec26 = Reflect.metadata("design:type", Function), _dec27 = Reflect.metadata("design:paramtypes", [Array]), _dec28 = Reflect.metadata("design:type", Function), _dec29 = Reflect.metadata("design:paramtypes", [Array]), _dec30 = Reflect.metadata("design:type", Function), _dec31 = Reflect.metadata("design:paramtypes", [Object]), _dec32 = Reflect.metadata("design:type", Array), _dec33 = Reflect.metadata("design:type", Object), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = /*#__PURE__*/function (_RcModule) {
  function WebSocketSubscription(_client, _storage, _ringCentralExtensions, _sleepDetector, _webSocketSubscriptionOptions) {
    var _this;
    ...
    _this._sleepDetected = false;
    _this._webSocketRecovered = false;
    _this._recovered$ = new _rxjs.Subject();
    ...
    _this._updateSubscriptionPromise = void 0;
  ...
  return _createClass(WebSocketSubscription, [{
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              this._ringCentralExtensions.webSocketRecovered$.pipe(_nextCore.takeUntilAppDestroy).subscribe(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
                var _this2$_updateSubscri;
                return _regenerator().w(function (_context5) {
                  while (1) switch (_context5.n) {
                    ...
                    case 1:
                      ...
                      _this2._webSocketRecovered = true;
                      _context5.n = 2;
                      return (_this2$_updateSubscri = _this2._updateSubscriptionPromise) === null || _this2$_updateSubscri === void 0 ? void 0 : _this2$_updateSubscri["catch"](function () {});
                    case 2:
                      _context5.n = 3;
                      return _this2._revokeSubscription();
                    case 3:
                      ...
                      return _this2._updateSubscription();
                    case 4:
                      _this2._webSocketRecovered = false;
                      _this2._recovered$.next();
                    case 5:
                      return _context5.a(2);
                  }
                }, _callee5);
    ...
    value: (function () {
      var _handleSleepDetected2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            case 0:
              this._sleepDetected = true;
              if (!(this._ringCentralExtensions.isWebSocketReady && this.getFilters().length)) {
                _context7.n = 2;
                break;
              }
              _context7.n = 1;
      ...
      function _handleSleepDetected() {
        return _handleSleepDetected2.apply(this, arguments);
      }
      return _handleSleepDetected;
    }())
  }, {
    ...
    value: function () {
      var _obtainSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(eventFilters) {
        var _this3 = this,
          _subscription$subscri;
        var isSleepDetected, isNewChannel, subscription, isNewSubscription;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            case 0:
              ...
              isSleepDetected = this._sleepDetected;
              this._sleepDetected = false;
              isNewChannel = !this.subscriptionChannel || !(0, _normalizeEventFilter.isTheSameWebSocket)(this.subscriptionChannel, this._ringCentralExtensions.webSocketExtension.ws.url) || isSleepDetected;
    ...
    value: function () {
      var _refreshSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(eventFilters) {
    ...
    value: function () {
      var _revokeSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var _t;
    ...
    value: function () {
      var _removeSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
    ...
    value: function () {
      var _updateSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              ...
              _context10.n = 1;
              return this._updateSubscriptionPromise;
            case 1:
    ...
    key: "_doUpdateSubscription",
    value: function () {
      var _doUpdateSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
      ...
      function _doUpdateSubscription() {
        return _doUpdateSubscription2.apply(this, arguments);
      }
      return _doUpdateSubscription;
    }()
  }, {
    key: "_debouncedUpdateSubscriptionCatchCancel",
    value: function () {
      var _debouncedUpdateSubscriptionCatchCancel2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        var _t2;
    ...
    value: function getFilters() {
      // Registered filters
      var filters = Array.from(this._subscriberMap.values()).reduce(function (acc, _ref3) {
     ...
     */
    function () {
      var _subscribe = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        var eventFilters,
          oldLength,
          _args13 = arguments;
    ...
    key: "unsubscribe",
    value: function () {
      var _unsubscribe = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        var eventFilters,
          oldLength,
          _args14 = arguments;
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "subscriptionInfo", [_nextCore.storage, _nextCore.state, _dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "subscriptionChannel", [_nextCore.storage, _nextCore.state, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _applyDecoratedDescriptor(_class2.prototype, "_setSubscriptionReady", [_nextCore.action, _dec0, _dec1], Object.getOwnPropertyDescriptor(_class2.prototype, "_setSubscriptionReady"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_setTokens", [_nextCore.action, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "_setTokens"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_updateSubscription", [_dec12, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "_updateSubscription"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_pushMessageBuffer", [_nextCore.action, _dec15, _dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "_pushMessageBuffer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_clearMessageBuffer", [_nextCore.action, _dec17, _dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "_clearMessageBuffer"), _class2.prototype), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "messageBuffer", [_nextCore.state, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _applyDecoratedDescriptor(_class2.prototype, "subscribe", [_dec20, _dec21, _dec22], Object.getOwnPropertyDescriptor(_class2.prototype, "subscribe"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "unsubscribe", [_dec23, _dec24, _dec25], Object.getOwnPropertyDescriptor(_class2.prototype, "unsubscribe"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_addFilters", [_nextCore.action, _dec26, _dec27], Object.getOwnPropertyDescriptor(_class2.prototype, "_addFilters"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_removeFilters", [_nextCore.action, _dec28, _dec29], Object.getOwnPropertyDescriptor(_class2.prototype, "_removeFilters"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_notifyMessage", [_nextCore.action, _dec30, _dec31], Object.getOwnPropertyDescriptor(_class2.prototype, "_notifyMessage"), _class2.prototype), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "filters", [_nextCore.state, _dec32], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "message", [_nextCore.state, _dec33], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
