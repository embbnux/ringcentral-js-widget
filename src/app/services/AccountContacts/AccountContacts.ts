...
export class AccountContacts extends RcModule implements ContactSource {
  constructor(
    ...
    private _accountContactsViewableManager: AccountContactsViewableManager,
  ...
  getPresenceSync(contact: IContact): ContactPresence | null {
    ...
    return (
      this._accountContactsViewableManager.presenceMap[extensionId] ?? null
    );
  }
  ...
  getPresence(
    ...
    return new Promise((resolve) => {
      ...
      if (
        ...
        Date.now() - this.presences[extensionId].timestamp <
          this._accountContactsViewableManager.presenceTtl
      ) {
