...
var CPRClient = exports.CPRClient = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.inject)('SdkConfig')(target, undefined, 8);
}, _dec3 = function _dec3(target, key) {
  return (0, _nextCore.optional)('CPRClientOptions')(target, undefined, 9);
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _services.AccountInfo === "undefined" ? Object : _services.AccountInfo, typeof _services.Auth === "undefined" ? Object : _services.Auth, typeof _services2.Brand === "undefined" ? Object : _services2.Brand, typeof _services.Client === "undefined" ? Object : _services.Client, typeof _services.ExtensionInfo === "undefined" ? Object : _services.ExtensionInfo, typeof _services2.Toast === "undefined" ? Object : _services2.Toast, typeof _services2.BrowserLogger === "undefined" ? Object : _services2.BrowserLogger, typeof _services2.UAParsedInfo === "undefined" ? Object : _services2.UAParsedInfo, typeof SDKConfig === "undefined" ? Object : SDKConfig, typeof CPRClientOptions === "undefined" ? Object : CPRClientOptions]), _dec6 = (0, _nextCore.delegate)('server'), _dec7 = Reflect.metadata("design:type", Function), _dec8 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = /*#__PURE__*/function (_RcModule) {
  function CPRClient(_accountInfo, _auth, _brand, _client, _extensionInfo, _toast, _browserLogger, _UAParsedInfo, _sdkConfig, _cPRClientOptions) {
    var _this;
  ...
  return _createClass(CPRClient, [{
    ...
    get: function get() {
      ...
      return !!((_this$_auth$token = this._auth.token) !== null && _this$_auth$token !== void 0 && (_this$_auth$token$sco = _this$_auth$token.scope) !== null && _this$_auth$token$sco !== void 0 && (_this$_auth$token$sco2 = _this$_auth$token$sco.includes) !== null && _this$_auth$token$sco2 !== void 0 && _this$_auth$token$sco2.call(_this$_auth$token$sco, 'ProblemReportsManagement') && (_this$_auth$token2 = this._auth.token) !== null && _this$_auth$token2 !== void 0 && (_this$_auth$token2$sc = _this$_auth$token2.scope) !== null && _this$_auth$token2$sc !== void 0 && (_this$_auth$token2$sc2 = _this$_auth$token2$sc.includes) !== null && _this$_auth$token2$sc2 !== void 0 && _this$_auth$token2$sc2.call(_this$_auth$token2$sc, 'SendUsageInfo'));
    }
  }, {
    key: "logsFilename",
    get: function get() {
      ...
      var _sendCPR = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(description, extraFiles) {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 2:
              _context2.n = 3;
              return this.collectAndZipCPRLogs({
    ...
    key: "collectAndZipCPRLogs",
    value: (function () {
      var _collectAndZipCPRLogs = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(_ref) {
        var scope, _ref$extraFiles, extraFiles, archive;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              scope = _ref.scope, _ref$extraFiles = _ref.extraFiles, extraFiles = _ref$extraFiles === void 0 ? [] : _ref$extraFiles;
              _context3.n = 1;
              return this._browserLogger.collectSanitizedLogs({
                extraFiles: extraFiles,
                scope: scope
              });
            case 1:
      ...
      function collectAndZipCPRLogs(_x3) {
        return _collectAndZipCPRLogs.apply(this, arguments);
      }
      return collectAndZipCPRLogs;
    }()
    /**
    ...
    value: (function () {
      var _getClientInfo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _this$_cPRClientOptio2;
        var _this$_cPRClientOptio3, _this$_cPRClientOptio4, clientAppType, dpVersion, clientDetails, _osInfo$os, _osInfo$os$name, _osInfo$browser, _osInfo$browser2, _osInfo$browser2$vers, osInfo;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              if (!((_this$_cPRClientOptio2 = this._cPRClientOptions) !== null && _this$_cPRClientOptio2 !== void 0 && _this$_cPRClientOptio2.clientInfoProvider)) {
                _context4.n = 2;
                break;
              }
              ...
              _context4.n = 1;
              return (_this$_cPRClientOptio3 = this._cPRClientOptions.clientInfoProvider) === null || _this$_cPRClientOptio3 === void 0 ? void 0 : (_this$_cPRClientOptio4 = _this$_cPRClientOptio3.getDpVersion) === null || _this$_cPRClientOptio4 === void 0 ? void 0 : _this$_cPRClientOptio4.call(_this$_cPRClientOptio3);
            case 1:
