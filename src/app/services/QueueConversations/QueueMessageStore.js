...
var QueueMessageStore = exports.QueueMessageStore = (_dec = (0, _nextCore.injectable)({
  ...
  function QueueMessageStore(_toast, _auth, _client, _dataFetcher, _connectivityMonitor, _messageEventSubscriber, _appFeatures, _grant, _callQueues, _portManager, _subscription, _availabilityMonitor, _tabManager, _messageStoreOptions, _queueConversationsOptions) {
    ...
    _this._queueConversationsOptions = _queueConversationsOptions;
  ...
  return _createClass(QueueMessageStore, [{
    ...
    key: "_enable",
    get: function get() {
      var _this$_messageStoreOp, _this$_messageStoreOp2, _this$_queueConversat, _this$_queueConversat2;
      return ((_this$_messageStoreOp = (_this$_messageStoreOp2 = this._messageStoreOptions) === null || _this$_messageStoreOp2 === void 0 ? void 0 : _this$_messageStoreOp2.enable) !== null && _this$_messageStoreOp !== void 0 ? _this$_messageStoreOp : true) && ((_this$_queueConversat = (_this$_queueConversat2 = this._queueConversationsOptions) === null || _this$_queueConversat2 === void 0 ? void 0 : _this$_queueConversat2.enable) !== null && _this$_queueConversat !== void 0 ? _this$_queueConversat : true);
    }
  }, {
    key: "_hasPermission",
    get: function get() {
      return Boolean(this._enable && this._appFeatures.hasReadTextPermission && this.eligibleGrantIds.length > 0);
    }
  }, {
...
}(_MessageStoreBase2.MessageStoreBase), _applyDecoratedDescriptor(_class2.prototype, "eligibleGrantIds", [_nextCore.computed, _dec9, _dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "eligibleGrantIds"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_eligibilitySignature", [_nextCore.computed, _dec1, _dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "_eligibilitySignature"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_resetForEligibleGrantChange", [_dec11, _dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "_resetForEligibleGrantChange"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class);
