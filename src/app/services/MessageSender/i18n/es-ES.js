...
var _default = exports["default"] = {
  ...
  textTooLong: 'Puede introducir hasta 1000 caracteres.',
  multipartTextTooLong: 'Puedes introducir hasta 5.000 caracteres.',
  ...
  notSmsToExtension: 'No se puede enviar un número de extensión con el número de teléfono principal. Si desea enviar a un número de extensión, solo tiene que introducirlo.',
  shortNumbersNotAvailable: 'El envío de SMS a números cortos no está disponible.',
  internationalSMSNotSupported: 'No se pueden enviar SMS a números de teléfono internacionales.',
  noInternalSMSPermission: 'No tiene permiso para enviar mensajes. Póngase en contacto con el administrador de la cuenta de {brand} para actualizar.',
