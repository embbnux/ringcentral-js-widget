/* eslint-disable */
export default {
  threadCreatedHint: 'Gesprek is aangemaakt.',
  threadResolvedHint: 'Gesprek is opgelost door {name}.',
  threadAssignedHint: 'Gesprek is toegewezen aan {name}.',
  threadAssignedToOwnerHint: 'Gesprek is toegewezen aan u.',
  ...
  attachmentSizeLimitation:
    'De totale grootte van de bijlagen mag niet groter zijn dan 1,5 MB.',
  someone: 'iemand',
} as const;
