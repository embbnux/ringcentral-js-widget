...
var AlertRenderer = exports.AlertRenderer = function AlertRenderer(_ref) {
  ...
  return function (message) {
    ...
    if (_RateExceededAlert["default"].handleMessage(message) && rateLimiter !== null && rateLimiter !== void 0 && rateLimiter.timestamp) {
      return function (props) {
    ...
    if (_CallLogAlert["default"].handleMessage(message)) {
      return _CallLogAlert["default"];
    }
    if (_CallControlAlert["default"].handleMessage(message)) {
      return _CallControlAlert["default"];
    }
    return function () {
      return null;
    };
