...
var MeetingSettingsCard = exports.MeetingSettingsCard = function MeetingSettingsCard(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (isNewMeeting && meeting.isOnlyAuthUserJoin && !meeting.isOnlyCoworkersJoin && !((_meeting$settingLock = meeting.settingLock) !== null && _meeting$settingLock !== void 0 && _meeting$settingLock.isOnlyAuthUserJoin)) {
    ...
    if (isNewMeeting && meeting.waitingRoomMode === _RcVideo.RCV_WAITING_ROOM_MODE.guests && !((_meeting$settingLock2 = meeting.settingLock) !== null && _meeting$settingLock2 !== void 0 && _meeting$settingLock2.waitingRoomMode)) {
