...
var FieldItem = exports.FieldItem = /*#__PURE__*/function (_Component) {
  function FieldItem() {
    ...
    _this.renderReference = function () {
      ...
      var rightIcon = (_rightIconRender = rightIconRender === null || rightIconRender === void 0 ? void 0 : rightIconRender(phoneNumber)) !== null && _rightIconRender !== void 0 ? _rightIconRender : undefined;
    ...
    _this.renderSelectMenu = function () {
      ...
      var selectList = (picklistOptions || []).reduce(function (acc, item) {
        if (item && _typeof(item) === 'object' && controller && currentLog !== null && currentLog !== void 0 && currentLog.task && item.validFor) {
    ...
    _this.renderAlert = function () {
      ...
      if (!(currentLog !== null && currentLog !== void 0 && currentLog.shouldPromoteAlert)) {
        return;
      }
    ...
    _this.renderTicketStatusSelectList = function () {
      ...
      var disabled = disableAllFields || disableSaveLog || (task === null || task === void 0 ? void 0 : task.isLogged) || !((_task$ticketStatuses2 = task.ticketStatuses) !== null && _task$ticketStatuses2 !== void 0 && _task$ticketStatuses2.length);
