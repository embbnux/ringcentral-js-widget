...
var ConversationPanel = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(ConversationPanel, [{
    ...
    value: function getMessageListHeight() {
      ...
      var extraHeight = 0;
      if (restrictSendMessage !== null && restrictSendMessage !== void 0 && restrictSendMessage(this.getSelectedContact())) {
      ...
      if (supportAttachment && attachments !== null && attachments !== void 0 && attachments.length) {
    ...
    function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: _styles["default"].logButton
      }, extraButton), logButton), ((_this$props$renderLog = (_this$props5 = this.props).renderLogInfoSection) === null || _this$props$renderLog === void 0 ? void 0 : _this$props$renderLog.call(_this$props5, this.props.conversation)) || null, conversationBody, (_this$props$restrictS = (_this$props6 = this.props).restrictSendMessage) !== null && _this$props$restrictS !== void 0 && _this$props$restrictS.call(_this$props6, this.getSelectedContact()) ? /*#__PURE__*/_react["default"].createElement(_juno.RcAlert, {
