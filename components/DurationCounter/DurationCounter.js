...
var InnerDurationCounter = function InnerDurationCounter(_ref) {
  var className = _ref.className,
    ...
    _ref$compensateSystem = _ref.compensateSystemTime,
    compensateSystemTime = _ref$compensateSystem === void 0 ? false : _ref$compensateSystem;
  var systemTimeOffsetRef = (0, _react.useRef)(0);
  var getFormattedDuration = (0, _react.useCallback)(function () {
    ...
    var rawDuration = Math.round((Date.now() - adjustedStartTime) / 1000);
