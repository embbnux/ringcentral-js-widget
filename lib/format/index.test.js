...
describe('format', function () {
  ...
  test('should format US number with 835 area code', function () {
    expect((0, _index["default"])({
      phoneNumber: '835-555-1234',
      countryCode: 'US'
    })).toBe('(835) 555-1234');
    expect((0, _index["default"])({
      phoneNumber: '835-555-1234',
  ...
  test('should return parser result with formatted number', function () {
    var result = (0, _index.formatWithParserResult)({
      phoneNumber: '16503618700*123',
      countryCode: 'US',
      removeExtension: true,
      type: _index.formatTypes.e164
    });
    expect(result.number).toBe('+16503618700');
    expect(result.parserResult.extension).toBe('123');
    expect(result.parserResult.isExtension).toBe(false);
  });
  test('should keep format result same as formatWithParserResult number', function () {
    var options = {
      phoneNumber: '+1 650-361-8700 * 123',
      countryCode: 'US',
      type: _index.formatTypes.e164
    };
    expect((0, _index["default"])(options)).toBe((0, _index.formatWithParserResult)(options).number);
  });
});
