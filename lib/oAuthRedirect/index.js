...
(function () {
  ...
  try {
    var _window$opener;
    if ((_window$opener = window.opener) !== null && _window$opener !== void 0 && _window$opener.oAuthCallback) {
  ...
  var postMessageToOpener = function postMessageToOpener() {
    try {
      var _window$opener2;
      if ((_window$opener2 = window.opener) !== null && _window$opener2 !== void 0 && _window$opener2.postMessage && combinedState !== null && combinedState !== void 0 && combinedState.origin) {
