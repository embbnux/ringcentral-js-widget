...
var _excluded = ["fields", "files", "query", "headers", "batch", "checkAllFilesNameNotHaveASCII"];
...
function multipartHttpRequest(platform) {
  ...
  var sendRequest = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(method, url, _ref6) {
      ...
      var fields, files, query, _ref6$headers, headers, batch, isCheckAllFilesNameNotHaveASCII, rest, contentType, result, hasNonASCII, uTF8FormData, formData, response, multipartResult, _result, responseData, _t, _t2;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            fields = _ref6.fields, files = _ref6.files, query = _ref6.query, _ref6$headers = _ref6.headers, headers = _ref6$headers === void 0 ? {} : _ref6$headers, batch = _ref6.batch, isCheckAllFilesNameNotHaveASCII = _ref6.checkAllFilesNameNotHaveASCII, rest = _objectWithoutProperties(_ref6, _excluded);
          ...
          case 3:
            hasNonASCII = isCheckAllFilesNameNotHaveASCII ? checkAllFilesNameNotHaveASCII(files) : false;
            if (!hasNonASCII) {
              _context.n = 7;
              break;
            }
