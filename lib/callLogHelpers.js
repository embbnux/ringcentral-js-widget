...
function isExtensionCall(callItem, mainCompanyNumbers) {
  ...
  var isCompanyNumber = function isCompanyNumber(phoneInfo) {
    if (phoneInfo !== null && phoneInfo !== void 0 && phoneInfo.phoneNumber && mainCompanyNumbers !== null && mainCompanyNumbers !== void 0 && mainCompanyNumbers.includes(phoneInfo.phoneNumber)) {
      return true;
    }
    return false;
  };
  ...
  if (isOutbound(callItem) && toMatches !== null && toMatches !== void 0 && toMatches.length) {
    return !!toMatches.find(function (match) {
      ...
      var phoneMatch = !!((_match$phoneNumbers = match.phoneNumbers) !== null && _match$phoneNumbers !== void 0 && _match$phoneNumbers.some(function (phone) {
        return phone.phoneNumber === (to === null || to === void 0 ? void 0 : to.phoneNumber);
      }));
      return phoneMatch;
    });
  } else if (isInbound(callItem) && fromMatches !== null && fromMatches !== void 0 && fromMatches.length) {
    return !!fromMatches.find(function (match) {
      ...
      var phoneMatch = !!((_match$phoneNumbers2 = match.phoneNumbers) !== null && _match$phoneNumbers2 !== void 0 && _match$phoneNumbers2.some(function (phone) {
