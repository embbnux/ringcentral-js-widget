  ...
  return _createClass(ServerTransport, [{
    ...
    value: function push(_ref3) {
      ...
      this._ports.forEach(function (port) {
        ...
        if ((_port$sender = port.sender) !== null && _port$sender !== void 0 && (_port$sender$tab = _port$sender.tab) !== null && _port$sender$tab !== void 0 && _port$sender$tab.id && (
    ...
    value: function send(_ref4) {
      ...
      this._ports.forEach(function (port) {
        ...
        if ((_port$sender2 = port.sender) !== null && _port$sender2 !== void 0 && (_port$sender2$tab = _port$sender2.tab) !== null && _port$sender2$tab !== void 0 && _port$sender2$tab.id // TODO: implement change active tab for syncing state
        // send to all instances if app failed to query active tabs
