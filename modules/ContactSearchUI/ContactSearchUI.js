...
var ContactSearchUI = exports.ContactSearchUI = (_dec = (0, _di.Module)({
  ...
  return _createClass(ContactSearchUI, [{
    ...
    value: function getFilteredCompanyContacts() {
      ...
      var contacts = (_this$_deps$contactSe2 = this._deps.contactSearchUIOptions) !== null && _this$_deps$contactSe2 !== void 0 && _this$_deps$contactSe2.filterCallQueueNumber ? accountContacts.filter(function (contact) {
    ...
    get: function get() {
      ...
      if ((_this$_deps$contactSe3 = this._deps.contactSearchUIOptions) !== null && _this$_deps$contactSe3 !== void 0 && _this$_deps$contactSe3.filterCallQueueNumber) return this.getFilteredCallQueueContacts(this.filterString);
      return [];
    }
  }, {
    ...
    value: function getUIProps(_ref) {
      ...
      return {
        ...
        isThirdPartySearching: !((_this$_deps$contactSe9 = this._deps.contactSearch) !== null && _this$_deps$contactSe9 !== void 0 && _this$_deps$contactSe9.isIdle),
