...
var ConferenceDialerUI = exports.ConferenceDialerUI = (_dec = (0, _di.Module)({
  ...
  return _createClass(ConferenceDialerUI, [{
    ...
    value: function _onBeforeCall(fromSessionId) {
      ...
      if (this._deps.conferenceCall && fromSessionId && !((_this$_deps$conferenc2 = this._deps.conferenceCall.mergingPair) !== null && _this$_deps$conferenc2 !== void 0 && _this$_deps$conferenc2.fromSessionId)) {
