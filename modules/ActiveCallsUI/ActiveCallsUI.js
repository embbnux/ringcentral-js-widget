  ...
  return _createClass(ActiveCallsUI, [{
    ...
    value: function getUIProps(_ref2) {
      ...
      return {
        ...
        showSpinner: !!((_this$_deps$conferenc = this._deps.conferenceCall) !== null && _this$_deps$conferenc !== void 0 && _this$_deps$conferenc.isMerging),
        ...
        showSwitchCall: !!(showSwitchCall && isWebRTC && (_this$_deps$webphone = this._deps.webphone) !== null && _this$_deps$webphone !== void 0 && _this$_deps$webphone.connected),
        autoLog: !!((_this$_deps$callLogge = this._deps.callLogger) !== null && _this$_deps$callLogge !== void 0 && _this$_deps$callLogge.autoLog),
        isWebRTC: isWebRTC,
    ...
    value: function getUIFunctions(_ref3) {
      ...
      return {
        ...
        isSessionAConferenceCall: function isSessionAConferenceCall(sessionId) {
          ...
          return !!((_this2$_deps$conferen = _this2._deps.conferenceCall) !== null && _this2$_deps$conferen !== void 0 && _this2$_deps$conferen.isConferenceSession(sessionId));
        },
