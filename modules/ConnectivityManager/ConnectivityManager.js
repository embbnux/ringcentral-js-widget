...
var ConnectivityManager = exports.ConnectivityManager = (_dec = (0, _di.Module)({
  ...
  return _createClass(ConnectivityManager, [{
    ...
    get: function get() {
      ...
      return !!((_this$_deps$callingSe = this._deps.callingSettings) !== null && _this$_deps$callingSe !== void 0 && _this$_deps$callingSe.isWebphoneMode) && (
    ...
    get: function get() {
      ...
      return !!((_this$_deps$webphone = this._deps.webphone) !== null && _this$_deps$webphone !== void 0 && _this$_deps$webphone.ready) && (this._deps.webphone.connecting || this._deps.webphone.reconnecting);
    }
  }, {
