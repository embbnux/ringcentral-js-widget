  ...
  return _createClass(SettingsUI, [{
    ...
    value: function getUIProps(_ref2) {
      ...
      return {
        ...
        showPresenceSettings: showPresenceSettings && !!((_this$_deps$extension = this._deps.extensionFeatures.features) !== null && _this$_deps$extension !== void 0 && (_this$_deps$extension2 = _this$_deps$extension.EditPresenceStatus) !== null && _this$_deps$extension2 !== void 0 && _this$_deps$extension2.available),
        ...
        showUserGuide: showUserGuide && !!((_this$_deps$userGuide = this._deps.userGuide) !== null && _this$_deps$userGuide !== void 0 && _this$_deps$userGuide.hasPermission),
        ...
        showRemoveMeetingWarning: !!((_this$_deps$settingsU = this._deps.settingsUIOptions) !== null && _this$_deps$settingsU !== void 0 && _this$_deps$settingsU.showRemoveMeetingWarning),
        showTrackingIssue: !!((_this$_deps$settingsU2 = this._deps.settingsUIOptions) !== null && _this$_deps$settingsU2 !== void 0 && _this$_deps$settingsU2.showTrackingIssue)
      };
    }
  }, {
    key: "getUIFunctions",
