...
var DialerUI = exports.DialerUI = (_dec = (0, _di.Module)({
  ...
  return _createClass(DialerUI, [{
    ...
    get: function get() {
      ...
      return this._deps.extensionFeatures.ready && !((_this$_deps$extension = this._deps.extensionFeatures.features) !== null && _this$_deps$extension !== void 0 && (_this$_deps$extension2 = _this$_deps$extension.EditOutboundCallerId) !== null && _this$_deps$extension2 !== void 0 && _this$_deps$extension2.available);
    }
  }, {
    key: "isShowAnonymous",
    get: function get() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              if (!((_this$_deps$dialerUIO = this._deps.dialerUIOptions) !== null && _this$_deps$dialerUIO !== void 0 && _this$_deps$dialerUIO.useV2 && ((_this$toNumberField = this.toNumberField) === null || _this$toNumberField === void 0 ? void 0 : _this$toNumberField.length) >= 3)) {
                _context2.n = 2;
                break;
              }
              _context2.n = 1;
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              ...
              if (recipient !== null && recipient !== void 0 && recipient.phoneNumber) {
    ...
    value: function isCallFromCurrentDevice(phoneNumber) {
      ...
      if ((phoneNumber !== null && phoneNumber !== void 0 && phoneNumber.includes(formattedPhoneNumber) || phoneNumber !== null && phoneNumber !== void 0 && phoneNumber.includes(originalPhoneNumber) || phoneNumber === this._deps.call.lastValidatedToNumber) && Date.now() - this._latestCallTime <= TIMEOUT) {
