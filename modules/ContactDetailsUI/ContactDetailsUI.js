  ...
  return _createClass(ContactDetailsUI, [{
    ...
    value: function getUIProps() {
      ...
      return {
        ...
        isCallButtonDisabled: !!((_this$_deps$connectiv = this._deps.connectivityManager) !== null && _this$_deps$connectiv !== void 0 && _this$_deps$connectiv.isOfflineMode || (_this$_deps$connectiv2 = this._deps.connectivityManager) !== null && _this$_deps$connectiv2 !== void 0 && _this$_deps$connectiv2.isWebphoneUnavailableMode || (_this$_deps$connectiv3 = this._deps.connectivityManager) !== null && _this$_deps$connectiv3 !== void 0 && _this$_deps$connectiv3.isWebphoneInitializing || (_this$_deps$rateLimit = this._deps.rateLimiter) !== null && _this$_deps$rateLimit !== void 0 && _this$_deps$rateLimit.throttling),
        disableLinks: !!((_this$_deps$connectiv4 = this._deps.connectivityManager) !== null && _this$_deps$connectiv4 !== void 0 && _this$_deps$connectiv4.isOfflineMode || (_this$_deps$connectiv5 = this._deps.connectivityManager) !== null && _this$_deps$connectiv5 !== void 0 && _this$_deps$connectiv5.isVoipOnlyMode || (_this$_deps$rateLimit2 = this._deps.rateLimiter) !== null && _this$_deps$rateLimit2 !== void 0 && _this$_deps$rateLimit2.throttling),
